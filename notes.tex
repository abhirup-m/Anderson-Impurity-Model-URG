...
\beq
\Delta^+_2 \ham_N = \sum_{q\beta k\sigma}u_P V_q^*c^\dagger_{d\beta}c_{q\beta}\hat n_{d\ol\beta}\fr{1}{\omega - \ham_D^+}c_{k\beta}c_{q\beta}^\dagger
\eeq
...
\eeq
\beq
\Delta^+_2 \ham_N &= \sum_{q\beta k\sigma}u_P V_q^*c^\dagger_{d\beta}c_{q\beta}\hat n_{d\ol\beta}c_{k\beta}c_{q\beta}^\dagger\fr{1}{\omega - H_1 + \epsilon_k - \epsilon_q^+}\\
		  &= \sum_{q\beta k\sigma}c^\dagger_{d\beta}c_{k\beta}\fr{-\hat n_{d\ol\beta}u_P {V_q^1}^*}{\omega - \epsilon_q^+ + \epsilon_k }
\eeq
\pb
\textbf{3.}
...
\begin{minipage}{330pt}
\beq
\Delta^+_4 \ham_N = \sum_{q\beta k\sigma\sigma^\prime}u_P^2 \hat n_{d\sigma}c_{q\beta}c^\dagger_{k\beta}\fr{1}{\omega - \ham_D^+}\hat n_{d\sigma^\prime}c_{k^\prime\beta} c^\dagger_{q\beta}
\eeq
The first step is a simplification:
\beq[simpl]
...
\eeq
\beq
\Delta^+_6 \ham_N &= \sum_{q\beta k} u_P^2 \rr{\hat n_{d} + 2\hat n_{d\ua}\hat n_{d\da}}c_{q\beta}c^\dagger_{k\beta}c_{k^\prime\beta} c^\dagger_{q\beta}\fr{1}{\omega - H_1}\\
		  &= \sum_{q\beta k} u_P^2 \rr{\hat n_{d} + 2\hat n_{d\ua}\hat n_{d\da}}\rr{1  - \hat n_{q\beta}}c^\dagger_{k\beta}c_{k^\prime\beta} \fr{1}{\omega - H_0 - \epsilon_q^+ + \epsilon_{k^\prime}}\\
\eeq
The first term gives
\beq
\sum_{q\beta k\sigma} u_P^2 \hat n_{d\sigma}c^\dagger_{k\beta}c_{k^\prime\beta} \fr{1}{\omega - \epsilon_q^+ + \epsilon_{k^\prime}} &= \sum_{q\beta k\sigma} c^\dagger_{k\beta}c^\dagger_{d\sigma}c_{k^\prime\beta}c_{d\sigma} \fr{-u_P^2}{\omega - \epsilon_q^+ + \epsilon_{k^\prime}}\\
\eeq
The second term gives
\beq
\sum_{q\beta k} \hat n_{d\ua}\hat n_{d\da}c^\dagger_{k\beta}c_{k^\prime\beta} \fr{2u_P^2 }{\omega - \epsilon_q^+ + \epsilon_{k^\prime}}\\
\eeq
In total,
\beq
\Delta^+_6 \ham_N =\sum_{q\beta k\sigma} c^\dagger_{k\beta}c^\dagger_{d\sigma}c_{k^\prime\beta}c_{d\sigma} \fr{-u_P^2}{\omega - \epsilon_q^+ + \epsilon_{k^\prime}} + \sum_{q\beta k} \hat n_{d\ua}\hat n_{d\da}c^\dagger_{k\beta}c_{k^\prime\beta} \fr{2u_P^2 }{\omega - \epsilon_q^+ + \epsilon_{k^\prime}}
\eeq
\pb
\textbf{7.}
\pb
...
H_1 = \epsilon_q^+ - u_P + \epsilon_d
\eeq
The initial (\il{\hat n_{q\beta}=\hat n_{d\beta}=0,\hat n_{k\beta}=\hat n_{d\ol\beta}=1}) energy is
\beq
...
\Delta^+_9 \ham_N &= \sum_{q\beta k k\prime}u_A^2 c^\dagger_{d\beta}c^\dagger_{k\ol\beta} c_{d\ol\beta}c_{q\beta}c^\dagger_{d\ol\beta}c_{q\beta}^\dagger c_{d\beta}c_{k^\prime\ol\beta}\fr{1}{\omega - H_0 - \epsilon_q^+ + \epsilon_{k^\prime}}\\
		  ...
		  &= \sum_{q\beta k k\prime}\rr{1 - \hat n_{d\beta}}c^\dagger_{k\beta} c^\dagger_{d\ol\beta}c_{k^\prime\beta}c_{d\ol\beta}\fr{u_A^2}{\omega - H_0 - \epsilon_q^+ + \epsilon_{k^\prime}}\\
\eeq
...
\Delta_4^- \ham_N &= \sum_{q\beta k}u_P V^*_q \rr{1 + \hat n_{d\ol\beta}}c_{k\beta}c^\dagger_{q\beta}c^\dagger_{d\beta}c_{q\beta}\fr{1}{\omega - H_0+ \epsilon_{q}^- + u_P  \rr{1 - \hat n_{d\ol\beta}} - \epsilon_d - U\hat n_{d\ol\beta}} \\
		  ...
		  &=\sum_{q\beta k}c^\dagger_{d\beta}c_{k\beta}\qq{\fr{2u_P {V^1_q}^* \hat n_{d\ol\beta}}{\omega - H_0 + \epsilon_{q}^- - \epsilon_d - U} + \fr{u_P {V^0_q}^* \rr{1 - \hat n_{d\ol\beta}}}{\omega - H_0 + \epsilon_{q}^- + u_P - \epsilon_d}} \\
\eeq
\textbf{5.}
\pb
\begin{minipage}{320pt}
...
\eeq
The intermediate (\il{\hat n_{q\beta}=0,\hat n_{k^\prime\beta}=1}) energy is
\beq
...
\end{minipage}
\pb
The initial state (\il{\hat n_{q\beta}=1,\hat n_{k^\prime\beta}=0}) energy is
\beq
...
\Delta_6^- \ham_N &= \sum_{q\beta kk^\prime}u_P^2\rr{\hat n_{d} + 2\hat n_{d\ua}\hat n_{d\da}}c_{k\beta}c^\dagger_{q\beta}c_{q\beta}c^\dagger_{k^\prime\beta}\fr{1}{\omega - H_1}\\
		  ...
		  &= \sum_{q\beta kk^\prime\sigma}\hat n_{d\sigma}c^\dagger_{k^\prime\beta}c_{k\beta}\fr{-u_P^2 }{\omega + \epsilon_q^- - \epsilon_{k^\prime}} + \sum_{q\beta kk^\prime}2\hat n_{d\ua}\hat n_{d\da}c^\dagger_{k^\prime\beta}c_{k\beta}\fr{-u_P^2}{\omega + \epsilon_q^- - \epsilon_{k^\prime}}\\
		  &+ \sum_{q\beta k\sigma}\hat n_{d\sigma}\fr{u_P^2 }{\omega + \epsilon_q^- - \epsilon_{k}} + \sum_{q\beta k}2\hat n_{d\ua}\hat n_{d\da}\fr{u_P^2}{\omega + \epsilon_q^- - \epsilon_{k}}
\eeq
\textbf{7.}
\pb
\begin{minipage}{320pt}
...
\eeq
The intermediate (\il{\hat n_{q\beta}=\hat n_{d\ol\beta}=0,\hat n_{{k^\prime}\ol\beta}=\hat n_{d\beta}=1}) energy is
\beq
H_1 = \epsilon_{k^\prime} - u_P + \epsilon_d
\eeq
The initial state (\il{\hat n_{q\beta}=\hat n_{d\ol\beta}=1,\hat n_{{k^\prime}\ol\beta}=\hat n_{d\beta}=0}) energy is
\beq
...
\eeq
The intermediate (\il{\hat n_{q\beta}=\hat n_{d\ol\beta}=0,\hat n_{k^\prime\beta}=\hat n_{d\beta}=1}) energy is
\beq
H_1 = \epsilon_{k^\prime} - u_P + \epsilon_d
\eeq
The initial state (\il{\hat n_{k^\prime\beta}=\hat n_{d\ol\beta}=0,\hat n_{q\beta}=\hat n_{d\beta}=1}) energy is
\beq
H_0 &= \epsilon_{q}^- - u_P + \epsilon_d = H_1 + \epsilon^-_q - \epsilon_k
\eeq
\end{minipage}
...
\Delta_8^- \ham_N &= \sum_{q\beta kk^\prime\sigma}u_Au_P c^\dagger_{d\ol\beta}c^\dagger_{q\beta}c_{d\beta}c_{k\ol\beta}c_{q\beta}c^\dagger_{k^\prime\beta}\fr{1}{\omega - H_1}\\
		  &= \sum_{q\beta kk^\prime}u_Au_P \hat n_{q\beta}c^\dagger_{k^\prime\beta}c^\dagger_{d\ol\beta}c_{k\ol\beta}c_{d\beta}\fr{1}{\omega - H_0 + \epsilon^-_q - \epsilon_k}\\
		  &= \sum_{q\beta kk^\prime}c^\dagger_{k\beta}c^\dagger_{d\ol\beta}c_{k^\prime\ol\beta}c_{d\beta}\fr{u_Au_P }{\omega + \epsilon^-_q - \epsilon_k}\\
\eeq
\textbf{9.}
\pb
\begin{minipage}{320pt}
...
\Delta_9^- \ham_N &= \sum_{q\beta kk^\prime}u_A^2c^\dagger_{d\ol\beta}c^\dagger_{q\beta}c_{d\beta}c_{k^\prime\ol\beta}c^\dagger_{d\beta} c^\dagger_{k\ol\beta}c_{d\ol\beta}c_{q\beta}\fr{1}{\omega - H_1}\\
		  &= \sum_{q\beta kk^\prime}\hat n_{q\beta}\rr{1 - \hat n_{d\beta}}c^\dagger_{d\ol\beta}c_{k^\prime\ol\beta}c^\dagger_{k\ol\beta}c_{d\ol\beta}\fr{u_Au_P }{\omega + \epsilon^-_q - \epsilon_k}\\
		  &= \sum_{q\beta kk^\prime}\rr{1 - \hat n_{d\beta}}c^\dagger_{k\ol\beta}c^\dagger_{d\ol\beta}c_{k^\prime\ol\beta}c_{d\ol\beta}\fr{u_Au_P }{\omega + \epsilon^-_q - \epsilon_k} + \sum_{q\beta k}\rr{1 - \hat n_{d\beta}}\hat n_{d\ol\beta}\fr{u_Au_P }{\omega + \epsilon^-_q - \epsilon_k}\\
\eeq
\subsubsection{Scaling equations}
\begin{equation}
\begin{aligned}
