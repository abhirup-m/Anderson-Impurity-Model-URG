...
\Delta \ham_N &= \sum_{q\beta}\tau_{q\beta}c^\dagger_{q\beta}\qq{V_q + \sum_{k\sigma}V_2 c^\dagger_{d\sigma}c_{k\sigma}}c_{d\beta}\times c^\dagger_{d\beta}\qq{V^*_q - \sum_{k^\prime\sigma^\prime} V_2 c_{d\sigma^\prime}c^\dagger_{k^\prime\sigma^\prime}}c_{q\beta}\\
	      &\times\fr{1}{\hat \omega - \rr{H_\text{imp} + \epsilon_q}\hat n_{q\beta}}\\
	      &= \sum_{q\beta}\qq{V_q - \sum_{k\sigma}V_2 c_{k\sigma}c^\dagger_{d\sigma}}\rr{1-\hat n_{d\beta}}\qq{V^*_q - \sum_{k^\prime\sigma^\prime} V_2 c_{d\sigma^\prime}c^\dagger_{k^\prime\sigma^\prime}}\fr{1}{\omega - \rr{H_\text{imp} + \epsilon_q}}\\
	      ...
	      &\quad+\left.\sum_{kk^\prime{\sigma\sigma^\prime}}V^2_2 c_{k\sigma}c^\dagger_{d\sigma}\rr{1-\hat n_{d\beta}}c_{d\sigma^\prime}c^\dagger_{k^\prime\sigma^\prime}\right]\fr{1}{\omega - \rr{H_\text{imp} + \epsilon_q}}
\eeq
The first term in \il{\Delta \ham_N} is (calculated in the previous section)
\beq
\sum_{q\beta}|V_q|^2\rr{1 - \hat n_{d\beta}}\fr{1}{\omega - \rr{H_\text{imp} + \epsilon_q}} = \sum_{q\beta}|V_q|^2\fr{\hat n_{d\beta}\rr{\epsilon_q - \omega + 2\epsilon_{d}} - \hat n_{d\ua}\hat n_{d\da}\epsilon_{d}}{\rr{\omega - \epsilon_q}\rr{\omega - \epsilon_q - \epsilon_{d}}}
...
\beq
	      &-\sum_{k\sigma q \beta}c_{k\sigma}c^\dagger_{d\sigma} V^*_q V_2 \fr{\rr{1 - \hat n_{d\beta}}}{\omega - \rr{H_\text{imp} + \epsilon_q}} \\
...
\beq
	      &-\sum_{q\beta k\sigma} V_qV_2 \rr{1-\hat n_{d\beta}}c_{d\sigma}c^\dagger_{k\sigma} \fr{1}{\omega - \rr{H_\text{imp} + \epsilon_q}}\\
	      &=-\sum_{q k\sigma} V_qV_2 \rr{1 + \rr{1 -\hat n_{d\ol\sigma}}}c_{d\sigma}c^\dagger_{k\sigma} \fr{1}{\omega - \rr{H_\text{imp} + \epsilon_q}}\\
	      &=-\sum_{q k\sigma} V_qV_2 c_{d\sigma}c^\dagger_{k\sigma} \rr{1 + \rr{1 -\hat n_{d\ol\sigma}}}\fr{1}{\omega - \rr{H_\text{imp} + \epsilon_q}}\\
	      &=-\sum_{q k\sigma} V_qV_2 c_{d\sigma}c^\dagger_{k\sigma} \qq{\fr{2}{\omega - \epsilon_d - \epsilon_q} + \hat n_{d\ol\sigma}\fr{3\epsilon_d + 2U + \epsilon_q - \omega}{\rr{\omega - 2\epsilon_d - U - \epsilon_q}\rr{\omega - \epsilon_d - \epsilon_q}}}\\
	      &=\sum_{q k\sigma} V_qV_2 c^\dagger_{k\sigma} c_{d\sigma}\qq{\fr{2}{\omega - \epsilon_d - \epsilon_q} - \hat n_{d\ol\sigma}\fr{3\epsilon_d + 2U + \epsilon_q - \omega}{\rr{\omega - 2\epsilon_d - U - \epsilon_q}\rr{\omega - \epsilon_d - \epsilon_q}}}
\eeq
...
\beq
	      ...
	      &=\sum_{kk^\prime q\sigma\sigma^\prime}V^2_2 c_{k\sigma}c^\dagger_{d\sigma}c_{d\sigma^\prime}c^\dagger_{k^\prime\sigma^\prime} \qq{\fr{2}{\omega - \epsilon_d - \epsilon_q} + \hat n_{d\ol\sigma^\prime}\fr{3\epsilon_d + 2U + \epsilon_q - \omega}{\rr{\omega - 2\epsilon_d - U - \epsilon_q}\rr{\omega - \epsilon_d - \epsilon_q}}}\\
	      &=\sum_{kq\sigma}V^2_2\hat n_{d\sigma} \qq{\fr{2}{\omega - \epsilon_d - \epsilon_q} + \hat n_{d\ol\sigma}\fr{3\epsilon_d + 2U + \epsilon_q - \omega}{\rr{\omega - 2\epsilon_d - U - \epsilon_q}\rr{\omega - \epsilon_d - \epsilon_q}}}\\
	      &- \sum_{kk^\prime q\sigma\sigma^\prime}V^2_2 c^\dagger_{k^\prime\sigma^\prime}c^\dagger_{d\sigma}c_{d\sigma^\prime} c_{k\sigma}\qq{\fr{2}{\omega - \epsilon_d - \epsilon_q} + \hat n_{d\ol\sigma^\prime}\fr{3\epsilon_d + 2U + \epsilon_q - \omega}{\rr{\omega - 2\epsilon_d - U - \epsilon_q}\rr{\omega - \epsilon_d - \epsilon_q}}}
\eeq
The first line in the final equation descrives the renormalization of \il{\epsilon_d} and \il{U} at order \il{V_2^2}.
...
\beq
\Delta \epsilon_d &= \sum_q \qq{|V_q|^2\fr{\epsilon_q - \omega + 2\epsilon_d}{\rr{\omega - \epsilon_q}\rr{\omega - \epsilon_q - \epsilon_d}} + \fr{2V_2^2}{\omega - \epsilon_q - \epsilon_d}}\\
\Delta U &= \sum_q\qq{-|V_q|^2 \fr{2\epsilon_d}{\rr{\omega - \epsilon_q}\rr{\omega - \epsilon_q - \epsilon_d}} + V_2^2\fr{3\epsilon_d + \epsilon_q - \omega}{\omega - 2\epsilon_d - \epsilon_q}}\\
\Delta V_k &= 2\sum_q \fr{V_q V_2}{\omega - \epsilon_q - \epsilon_d}\\
\Delta V_k^* &= 2\sum_q \fr{V_q^* V_2}{\omega - \epsilon_q}\\
\Delta V_2 &= -2\sum_q \fr{V_2^2}{\omega - \epsilon_q - \epsilon_d}\\
\eeq
The renormalised Hamiltonian is
\beq
\ham_{N-1} &= \sum_{k\sigma}\qq{\epsilon_k^{N-1} \hat n_{k\sigma} + V_{k}^{N-1} c^\dagger_{k\sigma} c_{d\sigma} + h.c.} + \epsilon_{d}^{N-1}\sum_\sigma  \hat n_{d\sigma} +  U^{N-1} \hat n_{d\ua} \hat n_{d\da} \\
	   ...
	   &+\sum_{k\sigma q}c^\dagger_{d\sigma} c_{k\sigma}\hat n_{d\ol\sigma}V^*_q V_2 \fr{\epsilon_q - \omega + 2\epsilon_{d}}{\rr{\omega - \epsilon_q}\rr{\omega - \epsilon_q - \epsilon_{d}}} \\
	   &- \sum_{q k\sigma} V_qV_2 c^\dagger_{k\sigma} c_{d\sigma}\hat n_{d\ol\sigma}\fr{3\epsilon_d + 2U + \epsilon_q - \omega}{\rr{\omega - 2\epsilon_d - U - \epsilon_q}\rr{\omega - \epsilon_d - \epsilon_q}}\\
	      &- \sum_{kk^\prime q\sigma\sigma^\prime}V^2_2 c^\dagger_{k^\prime\sigma^\prime}c^\dagger_{d\sigma}c_{d\sigma^\prime} c_{k\sigma}\hat n_{d\ol\sigma^\prime}\fr{3\epsilon_d + 2U + \epsilon_q - \omega}{\rr{\omega - 2\epsilon_d - U - \epsilon_q}\rr{\omega - \epsilon_d - \epsilon_q}}
\eeq
...
\beq
\delta V_1 &= 2\sum_q \fr{V_q V_2}{\omega - \epsilon_q - \epsilon_d}\\
	   &= -2 V_1 V_2 \rho \delta D \fr{1}{\omega - D - \epsilon_d}\\
