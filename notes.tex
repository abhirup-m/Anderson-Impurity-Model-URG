...
\beq
\fr{1}{2}\text{Tr}_{q\ua} \ham_j &= \sum_{k<\Lambda_N,\sigma}\epsilon_k \hat n_{k\sigma} + \epsilon_{d}\sum_\sigma  \hat n_{d\sigma} +  U \hat n_{d\ua} \hat n_{d\da} + \fr{1}{2}\text{Tr}_{q\ua}\cc{\epsilon_k \hat n_{q\ua}}\\
&= \sum_{k<\Lambda_N,\sigma}\epsilon_k \hat n_{k\sigma} + \epsilon_{d}\sum_\sigma  \hat n_{d\sigma} +  U \hat n_{d\ua} \hat n_{d\da} + \fr{1}{2}\epsilon_q\\
\fr{1}{2}\text{Tr}_{q\da} \fr{1}{2}\text{Tr}_{q\ua}\ham_j &= \sum_{k<\Lambda_N,\sigma}\epsilon_k \hat n_{k\sigma} + \epsilon_{d}\sum_\sigma  \hat n_{d\sigma} +  U \hat n_{d\ua} \hat n_{d\da} + \epsilon_q\\
\eeq
\beq[term1]
...
\eta_{q\beta} &= \text{Tr}_{q\beta}\rr{c^\dagger_{q\beta}\ham}c_{q\beta}\fr{1}{\hat \omega - \text{Tr}_{q\beta}\rr{\ham^D \hat n_{q\beta}}\hat n_{q\beta}}\\
	      &= V^*_q c^\dagger_{d\beta}c_{q\beta}\fr{1}{\hat \omega - \rr{\sum_{k<\Lambda_N,\sigma}\epsilon_k \hat n_{k\sigma} + \epsilon_{d}\sum_\sigma  \hat n_{d\sigma} +  U \hat n_{d\ua} \hat n_{d\da}}\hat n_{q\beta} - \epsilon_q\hat n_{q\beta}}\\
	      &= V^*_q c^\dagger_{d\beta}c_{q\beta}\fr{1}{\omega\hat n_{q\beta} - \rr{\epsilon_{d}\sum_\sigma \hat n_{d\sigma} + U \hat n_{d\ua}\hat n_{d\da} + \epsilon_q}\hat n_{q\beta}}\\
\eeq
...
\beq
\sum_{q\beta}\tau_{q\beta}\cc{c^\dagger_{q\beta}\text{Tr}_{q\beta}\rr{\ham c_{q\beta}},\eta_{q\beta}} &= \sum_{q\beta}\tau_{q\beta}\cc{V_q c^\dagger_{q\beta}c_{d\beta}, V^*_q c^\dagger_{d\beta}c_{q\beta}\fr{1}{\omega - \epsilon_q - \epsilon_{d}\hat n_{d\ol\beta}}}
\eeq
...
\beq
\sum_{q\beta}\fr{1}{2}|V_q|^2\qq{\hat n_{d\beta}\rr{\hat n_{q\beta} - 1}+ \hat n_{q\beta}\rr{1-\hat n_{d\beta}}}\qq{\hat n_{d\ol\beta}\fr{\epsilon_d}{\rr{\omega - \epsilon_q - \epsilon_{d}}\rr{\omega - \epsilon_q }} + \fr{1}{\omega - \epsilon_q }}\\
							     =\sum_{q\beta}\fr{1}{2}|V_q|^2\qq{\hat n_{q\beta}-\hat n_{d\beta}}\qq{\hat n_{d\ol\beta}\fr{\epsilon_d}{\rr{\omega - \epsilon_q - \epsilon_{d}}\rr{\omega - \epsilon_q }} + \fr{1}{\omega - \epsilon_q }} 
\eeq
\textbf{\textcolor{red}{Putting \il{\hat n_{q\beta} = 1}}}, and dropping the non-operator terms, we get
\beq[term2]
\sum_{\beta}\fr{1}{2}\hat n_{d\beta}\sum_q |V_q|^2\fr{\epsilon_q - \omega + 2\epsilon_{d}}{\rr{\omega - \epsilon_q}\rr{\omega - \epsilon_q - \epsilon_{d}}} -  \hat n_{d\ua}\hat n_{d\da}\sum_{q\beta}\fr{1}{2}|V_q|^2\fr{\epsilon_{d}}{\rr{\omega - \epsilon_q}\rr{\omega -\epsilon_q - \epsilon_{d}}}
\eeq
...
\beq[impren]
\Delta \epsilon_{d}^{N} \equiv \epsilon_{d}\big\vert_{N-1} - \epsilon_{d}\big\vert_{N} = \fr{1}{2}\sum_q |V_q|^2\fr{\epsilon_q - \omega + 2\epsilon_{d}}{\rr{\omega - \epsilon_q}\rr{\omega - \epsilon_q - \epsilon_{d}}} 
\eeq
...
\beq
\delta\epsilon_{d}(D) &=\hf|V|^2\rho(D)\fr{|\delta D|}{D}\fr{D + 2\epsilon_{d}}{D + \epsilon_{d}}\\
		      &=-\hf|V|^2\rho(D)\delta \rr{\ln D }\fr{D + 2\epsilon_{d}}{D + \epsilon_{d}}
\eeq
I used \il{\delta D = -|\delta D|}. Changing to continuum equation,
\beq
\dv{\epsilon_d}{\ln D} &= -\hf\fr{\Delta}{\pi}\fr{D + 2\epsilon_{d}}{D + \epsilon_{d}}
\eeq
...
\begin{gather}
\dv{\epsilon_d}{\ln D} =-\hf\fr{\Delta}{\pi} \\
\implies \epsilon_d + \hf\fr{\Delta}{\pi}\log D = \text{constant}
\end{gather}
...
\dv{\epsilon_d}{\ln D} &= \fr{1}{2}|V|^2n(D) \fr{\omega - D - 2\epsilon_{d}}{\rr{\omega - D}\rr{\omega - D - \epsilon_{d}}} \\
		       &= \fr{1}{2}|V|^2n(D) \rr{\fr{2}{\omega - D} - \fr{1}{\omega - D - \epsilon_d}} \\
\eeq
...
\beq
\delta U &= -\sum_{q\beta}\fr{1}{2}|V_q|^2\fr{\epsilon_{d}}{\rr{\omega - \epsilon_q}\rr{\omega -\epsilon_q - \epsilon_{d}}}\\
		       &= -\fr{1}{2}|V|^2n(D) \sum_\beta\fr{\epsilon_{d}}{\rr{\omega - D}\rr{\omega -D - \epsilon_{d}}}\\
...
\implies \dv{U}{\ln D} &= |V|^2n(D) \fr{\epsilon_{d}}{\rr{\omega - D}\rr{\omega -D - \epsilon_{d}}}\\
		       &= |V|^2n(D) \rr{\fr{1}{\omega - D - \epsilon_{d}} - \fr{1}{\omega - D}}\\
\eeq
...
\pb
\textcolor{red}{Putting \il{\omega = \fr{3D}{2} + \fr{\epsilon_d}{2}},}
\beq
\dv{\epsilon_d}{\ln D} &= \fr{1}{2}|V|^2n(D) \rr{\fr{2}{\fr{D}{2} + \fr{\epsilon_d}{2}} - \fr{1}{\fr{D}{2} - \fr{\epsilon_d}{2}}} = |V|^2n(D) \rr{\fr{2}{D + \epsilon_d} - \fr{1}{D - \epsilon_d}} \\
\dv{U}{\ln D}	       &= |V|^2n(D) \rr{\fr{1}{\fr{D}{2} - \fr{\epsilon_d}{2}} - \fr{1}{\fr{D}{2} + \fr{\epsilon_d}{2}}} = 2|V|^2n(D) \rr{\fr{1}{D - \epsilon_d} - \fr{1}{D + \epsilon_d}}\\
\eeq
...
\beq
\ham_{q\beta} = \prod_{q\beta}\fr{1}{2}\text{Tr}_{q\beta}\ham_N + \sum_{q\beta}\tau_{q\beta} \cc{c^\dagger_{q\beta} \text{Tr}_{q\beta}\rr{\ham_N c_{q\beta}},\eta_{q\beta}}
\eeq
The calculations follow. As a first approximation, we will consider just one electron on the outermost shell \il{\Lambda_N}.
\beq
\ham_N = \sum^<_{k\sigma}\rr{\epsilon_k \tau_{k\sigma} + V_{k} c^\dagger_{k\sigma} c_{d\sigma} + h.c.} + \xi_{d}\sum_\sigma \tau_{d\sigma} +  U \tau_{d\ua} \tau_{d\da} + \epsilon_q \tau_{q\beta} + V_{q} c^\dagger_{q\beta} c_{d\beta} + h.c.
\eeq
...
\beq
\prod_{q\beta}\fr{1}{2}\text{Tr}_{q\beta}\ham_N = \sum_{k\sigma}^<\rr{\epsilon_k \tau_{k\sigma} + V_{k} c^\dagger_{k\sigma} c_{d\sigma} + h.c.} + \xi_{d}\sum_\sigma \tau_{d\sigma} +  U \tau_{d\ua} \tau_{d\da}
\eeq
...
\text{Tr}_{q\beta}\rr{\ham^D_N \hat n_{q\beta}}\hat n_{q\beta} = \qq{\sum^<_{k\sigma}\rr{\epsilon_k \tau_{k\sigma} + V_{k} c^\dagger_{k\sigma} c_{d\sigma} + h.c.} + \xi_{d}\sum_\sigma \tau_{d\sigma} +  U \tau_{d\ua} \tau_{d\da} + \fr{1}{2}\epsilon_q}\hat n_{q\beta}
\end{gather}
\beq
\eta_{q\beta} &= \text{Tr}_{q\beta}\rr{ c_{q\beta}^\dagger \ham_N} c_{q\beta}\fr{1}{\hat \omega - \text{Tr}_{q\beta}\rr{\ham^D_N \hat n_{q\beta}}\hat n_{q\beta}}\\
	      &= V^*_q c^\dagger_{d\beta}c_{q\beta}\fr{1}{\hat \omega - \rr{\xi_{d}\sum_\sigma \tau_{d\sigma} +  U \tau_{d\ua} \tau_{d\da} + \fr{1}{2}\epsilon_q}\hat n_{q\beta}}
\eeq
\textbf{\textcolor{red}{where I absorbed the part below the shell into the \il{\hat \omega}. We can replace \il{\hat \omega} with \il{\fr{\omega}{2} \hat n_{q\beta}}}}:
\beq
\eta_{q\beta} &= V^*_q c^\dagger_{d\beta}c_{q\beta}\fr{1}{\qq{\fr{1}{2}\omega - \rr{ \xi_{d}\sum_\sigma\tau_{d\sigma} +  U \tau_{d\ua} \tau_{d\da} + \fr{1}{2}\epsilon_q}}\hat n_{q\beta}}
\eeq
Since this term has a \il{c_{q\beta}}, it will survive only when acting on \il{\ket{\hat n_{q\beta} = 1}}, so we can replace the \il{\hat n_{q\beta}} in the denominator with \il{1}. Also, since there is a \il{c^\dagger_{d\beta}}, we can similarly replace \il{\tau_{d\beta} = -\fr{1}{2}}.

\beq
\eta_{q\beta} &= V^*_q c^\dagger_{d\beta}c_{q\beta}\fr{1}{\fr{1}{2}\omega  + \xi_{d}\rr{\fr{1}{2} -  \tau_{d\ol\beta}} + \fr{1}{2}U \tau_{d\ol\beta} - \fr{1}{2}\epsilon_q}\\
	      &= V^*_q c^\dagger_{d\beta}c_{q\beta}\fr{1}{\fr{1}{2}\rr{\omega  + \xi_{d} - \epsilon_q} -\rr{\xi_{d}- \fr{1}{2}U} \tau_{d\ol\beta}}\\
	      &\equiv V^*_q c^\dagger_{d\beta}c_{q\beta}\fr{1}{\fr{1}{2}A -B \tau_{d\ol\beta}}\\
	      &\equiv V^*_q c^\dagger_{d\beta}c_{q\beta}\qq{\fr{2\hat n_{d\ol\beta}}{A - B} + \fr{2\rr{1 - \hat n_{d\ol\beta}}}{A + B}}\\
	      &\equiv V^*_q c^\dagger_{d\beta}c_{q\beta}\qq{\fr{4B\hat n_{d\ol\beta}}{A^2 - B^2} + \fr{2}{A + B}}\\
\eeq
Then,
\beq
\tau_{q\beta} \cc{c^\dagger_{q\beta} \text{Tr}_{q\beta}\rr{\ham_N c_{q\beta}},\eta_{q\beta}} &= \tau_{q\beta}|V_q|^2\qq{\fr{4B\hat n_{d\ol\beta}}{A^2 - B^2} + \fr{2}{A + B}}\cc{c^\dagger_{q\beta}c_{d\beta},c^\dagger_{d\beta}c_{q\beta}}\\
											     &= \tau_{q\beta}|V_q|^2\qq{\fr{4B\hat n_{d\ol\beta}}{A^2 - B^2} + \fr{2}{A + B}}\cc{\hat n_{q\beta} - \hat n_{d\beta}}
\eeq
\textbf{\textcolor{red}{Putting \il{\tau_{q\beta} = \fr{1}{2}}}},
\beq
\tau_{q\beta} \cc{c^\dagger_{q\beta} \text{Tr}_{q\beta}\rr{\ham_N c_{q\beta}},\eta_{q\beta}} &=|V_q|^2\qq{\fr{2B\hat n_{d\ol\beta}}{A^2 - B^2} + \fr{1}{A + B}}\cc{1 - \hat n_{d\beta}}\\
&=|V_q|^2\qq{\fr{2B\hat n_{d\ol\beta}}{A^2 - B^2} + \fr{1}{A + B} - \fr{2B\hat n_{d\beta}\hat n_{d\ol\beta}}{A^2 - B^2} - \fr{\hat n_{d\beta}}{A + B}}\\
\sum_{q\beta}\tau_{q\beta} \cc{c^\dagger_{q\beta} \text{Tr}_{q\beta}\rr{\ham_N c_{q\beta}},\eta_{q\beta}} &=\sum_{q\beta}|V_q|^2\qq{\fr{2B\hat n_{d\ol\beta}}{A^2 - B^2} + \fr{1}{A + B} - \fr{2B\hat n_{d\beta}\hat n_{d\ol\beta}}{A^2 - B^2} - \fr{\hat n_{d\beta}}{A + B}}\\
\eeq
Since \il{A} and \il{B} are independent of the index \il{\beta}, we can change \il{\ol\beta} to \il{\beta} because they are being summed over. Dropping the operator-free term,
\beq
\sum_{q\beta}\tau_{q\beta} \cc{c^\dagger_{q\beta} \text{Tr}_{q\beta}\rr{\ham_N c_{q\beta}},\eta_{q\beta}} &=\sum_{q\beta}|V_q|^2\qq{\fr{\rr{3B - A}\hat n_{d\ol\beta}}{A^2 - B^2} - \fr{2B\hat n_{d\beta}\hat n_{d\ol\beta}}{A^2 - B^2}}
\eeq
The first term is a renormalization in the onsite energy of the impurity \il{ \xi_d}. The second term renormalizes the impurity-impurity repulsion energy \il{ U}.
\beq
\Delta \xi_d &= \sum_{q}|V_q|^2\fr{\rr{3B - A}}{A^2 - B^2}\\
	     &= \sum_{q}|V_q|^2\fr{\qq{\rr{A+B}-2\rr{A-B}}}{A^2 - B^2}\\
	     &= \sum_{q}|V_q|^2\qq{\fr{1}{A-B} -\fr{2}{A+B}}\\
	     &= n(D)|V|^2\qq{\fr{1}{A-B} -\fr{2}{A+B}}\\
\Delta U &= -\sum_{q\beta}|V_q|^2 \fr{2B}{A^2 - B^2}\\
&= 2n(D)|V|^2 \qq{ \fr{1}{A+B}-\fr{1}{A-B}}\\
\eeq
Substituting the values of \il{A,B} and putting \il{\epsilon_q = D},
\beq
\Delta \xi_d &= n(D)|V|^2\qq{\fr{1}{\omega - D + \fr{U}{2}} - \fr{2}{\omega - D + 2\xi_d - \fr{U}{2}}}\\
\Delta U &=  2n(D)|V|^2\qq{\fr{1}{\omega - D + 2\xi_d - \fr{U}{2}}- \fr{1}{\omega - D + \fr{U}{2}}}
\eeq
\textcolor{red}{Putting \il{\omega = -\xi_d}},
\beq
\Delta \xi_d &= n(D)|V|^2\qq{\fr{2}{D - \rr{\xi_d - \fr{U}{2}}}- \fr{1}{D + \rr{\xi_d - \fr{U}{2}}}}\\
	     &= n(D)|V|^2\qq{\fr{2}{D - \epsilon_d}- \fr{1}{D + \epsilon_d}}\\
\Delta U &= 2n(D)|V|^2\qq{\fr{1}{D + \rr{\xi_d - \fr{U}{2}}}- \fr{1}{D - \rr{\xi_d - \fr{U}{2}}}}\\
	 &= 2n(D)|V|^2\qq{\fr{1}{D + \epsilon_d}- \fr{1}{D - \epsilon_d}}\\
\eeq
\textcolor{red}{Putting \il{\omega = 2D -\xi_d}},
\beq
\Delta \xi_d &= -n(D)|V|^2\qq{\fr{2}{D + \epsilon_d}- \fr{1}{D - \epsilon_d}}\\
\Delta U  &= -2n(D)|V|^2\qq{\fr{1}{D - \epsilon_d}- \fr{1}{D + \epsilon_d}}\\
\eeq

\subsection*{Alternate-II}}
At first order, the rotated Hamiltonian is
\beq
\ham_{j-1} = 2^{-n_j}\text{Tr}_{1,2,...,n_j}\ham_j + \sum_{q\beta}\tau_{q\beta}\cc{c^\dagger_{q\beta}\text{Tr}_{q\beta}\rr{\ham c_{q\beta}},\eta_{q\beta}}
\eeq
...
\eeq
At the last step, \textbf{\textcolor{red}{I replaced \il{\pmb{\hat \omega - \sum_{k<\Lambda_N,\sigma}\epsilon_k \hat n_{k\sigma}\hat n_{q\beta} - \fr{1}{2}\rr{\epsilon_{d}\sum_\sigma \hat n_{d\sigma} + U \hat n_{d\ua}\hat n_{d\da} + \epsilon_q} }} with \il{\pmb{\omega\tau_{q\beta}}}}}. Note that since this term has a \il{c^\dagger_{d\beta}}, it will not vanish only when acting on a state with \il{\hat n_{d\beta} = 0}. Hence we can drop the terms \il{\hat n_{d\ua}\hat n_{d\da}} and \il{\epsilon_{d\beta}\hat n_{d\beta}} in the denominator. Also, since it has a \il{c_{q\beta}}, we can set the \il{\tau_{q\beta}} in the denominator to \hf. Putting together the individual pieces, we can now write the second term:
\beq
