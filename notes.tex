...
Expanding in this basis gives
\beq
\Delta_6^+ \ham_N &= \sum_{k^\prime q\beta k}c^\dagger_{k\beta}c_{k^\prime\beta}\qq{\fr{\fr{1}{4}J_z^2\hat n_{d\beta}\rr{1 - \hat n_{d\ol\beta}}}{\omega^+ - \epsilon_q - \hf\rr{J_c + J_z}} + \fr{\fr{1}{4}J_z^2\hat n_{d\ol\beta}\rr{1 - \hat n_{d\beta}}}{\omega^+ - \epsilon_q - \hf\rr{J_c - J_z}} + \fr{J_c^2\hat n_{d\beta}\hat n_{d\ol\beta}}{\omega^+ - \epsilon_q - J_c}}\\
\eeq
\paragraph{7.}
\beq
