...
\eeq
We can calculate the commutator by looking at the expression of \il{s^-} from eq.~\ref{sminus}: \il{s^- = \sum_{k_1,k_2}c^\dagger_{k_1\ua}c_{k_2\da}}. The commutator becomes
\beq
\qq{\ham^*_0, s^-} &= \sum_{k,k_1,k_2,\sigma}\epsilon_k\qq{c^\dagger_{k\sigma}c_{k\sigma},c^\dagger_{k_1,\ua}c_{k_2,\da}}\\
		   &=\sum_{k,k_1,k_2}\epsilon_k\rr{c^\dagger_{k\da}\qq{c_{k\da},c^\dagger_{k_1,\ua}c_{k_2,\da}} + \qq{c^\dagger_{k\da},c^\dagger_{k_1,\ua}c_{k_2,\da}}c_{k\da}}\\
		   &=\sum_{k,k_1,k_2}\epsilon_k\rr{c^\dagger_{k\da}\qq{c_{k\da}c^\dagger_{k_1,\ua}c_{k_2,\da} - c^\dagger_{k_1,\ua}c_{k_2,\da}c_{k\da}} + \qq{c^\dagger_{k\da}c^\dagger_{k_1,\ua}c_{k_2,\da} - c^\dagger_{k_1,\ua}c_{k_2,\da}c^\dagger_{k\da}}c_{k\da}}\\
		   &=\sum_{k,k_1,k_2}\epsilon_k\rr{-c^\dagger_{k\da}c^\dagger_{k_1,\ua}\cc{c_{k\da},c_{k_2,\da}}- c^\dagger_{k_1,\ua}\cc{c^\dagger_{k\da},c_{k_2,\da}}c_{k\da}}\\
		   &=\sum_{k,k_1,k_2}\epsilon_k c^\dagger_{k_1,\ua}\delta_{k,k_2} c_{k\da}\\
		   &= \sum_{k,q,\da}\epsilon_q c^\dagger_{k\ua}c_{q\da}\\
\eeq
\beq
\cc{\ham_0^*,\qq{\ham^*_0, s^-}} &= \sum_{k,q,k^\prime,\sigma}\epsilon_{k^\prime}\epsilon_q\cc{c^\dagger_{k^\prime\sigma}c_{k^\prime\sigma},c^\dagger_{k\ua}c_{q\da}} \\
				 &= \sum_{k,q,k^\prime}\epsilon_{k^\prime}\epsilon_q\qq{c^\dagger_{k\ua}c_{q\da}\rr{\delta_{kk^\prime} + \delta_{qk^\prime}} +2c^\dagger_{k\ua}\rr{n_{k^\prime\ua} + n_{k^\prime\da}}c_{q\da}}\\
\eeq
\end{document}
