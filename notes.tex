...
\eeq
\pb
\paragraph{A more careful calculation with both channels affecting \il{\epsilon_d} and \il{U}}:
...
&= -\hf\sum_{q\beta}\hat n_{d\ol\beta}\fr{V_{q+}^2}{\omega - \hf\epsilon_q + 2\epsilon_d + U} + \hf\sum_{q\beta}\hat n_{d\beta}\hat n_{d\ol\beta}\rr{\fr{V_{q+}^2}{\omega - \hf\epsilon_q + 2\epsilon_d + U} - \fr{V^2_{q-}}{\omega - \hf\epsilon_q + \epsilon_d}}\\
\eeq
\paragraph{2.}
\beq
&\hf\sum_{k\sigma q\beta}V_2 V_q c^\dagger_{q\beta} c_{d\beta}\fr{1}{\hat \omega - H_\text{imp}} c^\dagger_{d\beta} c^\dagger_{k\sigma}c_{d\sigma}c_{q\beta} \\
...
\paragraph{Scaling equations}
\beq
\Delta \epsilon_d &= -\hf\sum_q\qq{\fr{|V_{q-}|^2}{\omega - \hf\epsilon_q} + \fr{|V_{q+}|^2}{\omega - \hf\epsilon_q + 2\epsilon_d + U}}\\
...
\beq
&\Delta \ham_N\\
&= \sum_{q\beta}\qq{V_q + \sum_{k\sigma}V_2 c^\dagger_{d\sigma}c_{k\sigma}}c_{d\beta}c^\dagger_{q\beta}\fr{-1/2}{\hat \omega - \rr{H_\text{imp} - \fr{\epsilon_q}{2}}\rr{1 - \hat n_{q\beta}}}c_{q\beta}c^\dagger_{d\beta}\qq{V^*_q + \sum_{k^\prime\sigma^\prime} V_2 c^\dagger_{k^\prime\sigma^\prime}c_{d\sigma^\prime}}\\
...
&= \hf\sum_{q\beta}\qq{V_q + \sum_{k\sigma}V_2 c^\dagger_{d\sigma}c_{k\sigma}}c_{d\beta}c^\dagger_{q\beta}\fr{1}{\omega - \rr{ \fr{\epsilon_q}{2} - \hf U\tau_{d\ol\beta}}}c_{q\beta}c^\dagger_{d\beta}\qq{V^*_q + \sum_{k^\prime\sigma^\prime} V_2 c^\dagger_{k^\prime\sigma^\prime}c_{d\sigma^\prime}}\\
\eeq
\paragraph{1.}
\beq
...
&= \hf\sum_{q\beta}\rr{\hf - \tau_{d\beta}}\qq{\hf\rr{\fr{V^2_p}{\omega - \fr{\epsilon_q}{2} + \fr{U}{4}} + \fr{V^2_m}{\omega - \fr{\epsilon_q}{2} - \fr{U}{4} }} + \tau_{d\ol\beta}\rr{\fr{V^2_p}{\omega - \fr{\epsilon_q}{2} + \fr{U}{4}} - \fr{V^2_m}{\omega - \fr{\epsilon_q}{2} - \fr{U}{4}}}} \\
&= \hf\sum_{q\beta}\qq{-\tau_{d\beta}\fr{V^2_m}{\omega - \fr{\epsilon_q}{2} - \fr{U}{4} } - \tau_{d\beta}\tau_{d\ol\beta}\rr{\fr{V^2_p}{\omega - \fr{\epsilon_q}{2} + \fr{U}{4}} - \fr{V^2_m}{\omega - \fr{\epsilon_q}{2} - \fr{U}{4}}}} \\
&= -\hf\sum_{q\beta}\qq{\tau_{d\beta}\fr{V^2_m}{\omega - \fr{\epsilon_q}{2} - \fr{U}{4}} + \tau_{d\beta}\tau_{d\ol\beta}\rr{\fr{V^2_p}{\omega - \fr{\epsilon_q}{2} + \fr{U}{4}} - \fr{V^2_m}{\omega - \fr{\epsilon_q}{2} - \fr{U}{4}}}} \\
\eeq
