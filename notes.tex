...
\beq
\Delta \ham =& - \sum_{k\sigma}\qq{W_{kk} + \hat n_{d\ol\sigma}J_{kk}}\hat n_{d\sigma} &&&& \qq{\text{renormalization in \(\epsilon_d, U\)}}\\
	     ...
	     &+ \hf\sum_{kq\sigma}J_{kq}c^\dagger_{k\sigma}c_{d\sigma} c^\dagger_{q\ol\sigma}c_{d\ol\sigma} + \text{h.c.} &&&& \qq{\text{charge Kondo}}\\
\eeq
%}
\subsection{CUT RG}
