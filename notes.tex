...
\eeq
\subsubsection{Scaling equations (New)}
\begin{equation*}
\begin{aligned}
...
\Delta V_k^1 &=\sum_q V_q^1\qq{\fr{u_1 + 2u_2}{\omega + \epsilon_q^- - \epsilon_k^+ - u_2} + 
\fr{u_1 - u_2}{\omega - \epsilon_q^+ + \epsilon_d + U + u_2}} \\
\Delta {V_k^1}^* &= \sum_q  {V_q^1}^*\qq{\fr{u_1- u_2}{\omega + \epsilon_k^- - \epsilon_q^+ + u_2} + \fr{u_1  + 2u_2}{\omega + \epsilon_q^- - \epsilon_d - U - u_2}}\\
\Delta V_k^0 &= \sum_q V_q^0\fr{2u_1 + u_2}{\omega + \epsilon_q^- - \epsilon_k^+}\\
