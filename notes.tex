...
\beq
\sum_{k,q,\sigma,\sigma^\prime}c^\dagger_{k\sigma}c^\dagger_{d\sigma^\prime}c_{q\sigma}c_{d\sigma^\prime} &\to \sum_{k,q,\sigma,\sigma^\prime}c_{k\sigma}c_{d\sigma^\prime}c^\dagger_{q\sigma}c^\dagger_{d\sigma^\prime}
\eeq
...
\ham_N &= H_{N-1} + H_{imp} + \epsilon_q \hat n_{q\beta} + V_k c^\dagger_{q\beta}c_{d\beta} + \text{h.c.}  \\
       &\quad+ \sum_{k<\Lambda_N}u_A \rr{c^\dagger_{q\beta}c^\dagger_{d\ol\beta}c_{k\ol\beta}c_{d\beta} + c^\dagger_{k\ol\beta}c^\dagger_{d\beta}c_{q\beta}c_{d\ol\beta}}\\
       ...
       &\quad-\sum_{\sigma}\fr{u_P}{2}\qq{\hat n_{q\beta} \hat n_{d\sigma} + \rr{1 - \hat n_{q\beta}} \rr{1 - \hat n_{d\sigma}}}\\
