...
\beq
\Delta \ham_N = \sum_{q\beta}\tau_{q\beta}\fr{1}{\hat \omega - H_{imp}\rr{1 - \hat n_{q\beta} }}\times c^\dagger_{d\beta}\qq{V^*_q - \sum_{k^\prime\sigma^\prime} V_2 c_{d\sigma^\prime}c^\dagger_{k^\prime\sigma^\prime}}c_{q\beta}\times\\
