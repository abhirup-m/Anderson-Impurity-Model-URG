...
Under mean-field,
\beq
n_{d\ua}n_{d\da} \approx n_{d\ua}\avg{n_{d\da}} + n_{d\da}\avg{n_{d\ua}} = \fr{1}{N^2}\sum_{k,q,\sigma} n_{k\sigma} \avg{n_{q,-\sigma}}
\eeq
...
\eeq
The effective one-particle energy becomes
\beq
\wl\epsilon_{k\sigma} = \epsilon_k + \fr{U}{N^2}\sum_q \avg{\delta n_{q,-\sigma}}
\eeq
