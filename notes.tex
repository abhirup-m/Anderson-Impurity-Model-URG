...
\beq
m = \fr{1}{\beta}\pd{\ln Z}{B} \implies \chi = \lim_{B \to 0}\pd{m}{B} = \lim_{B \to 0}\fr{1}{\beta}\qq{\fr{1}{Z}\fr{\partial^2 Z}{\partial B^2} + \rr{\pd{Z}{B}}^2}
\eeq
...
\beq
\ham_\text{coll} = \fr{J^*}{2}\sum_{k_1,k_2 < \Lambda^*\atop{\alpha,\beta}} \mb{S}\cdot \mb{\sigma}_{\alpha\beta} c^\dagger_{k_1,\alpha} c_{k_2,\beta} + \sum_{k>\Lambda^*} J_k S^z s^z_k = J^* \mb{S}\cdot \mb{s} + S^z \sum_{k>\Lambda^*} J_k s^z_k
\eeq
where
\beq
...
The ground state is
\beq
\ket{\Psi^*} = \sum_{|\mb{k}|<\Lambda^*\atop{\mb{q}\neq \mb{k}}}\rr{\ket{\ua_d}\ket{\da_\mb{k}} \otimes \ket{s^z_\mb{q}=-\fr{1}{2}}- \ket{\da_d}\ket{\ua_\mb{k}}\otimes \ket{s^z_\mb{q}=\fr{1}{2}}}
\eeq
which is verified easily:
\beq
S^z \sum_{k>\Lambda^*} J_k s^z_k \ket{\Psi^*} &= S^z\sum_{k>\Lambda^*} J_k \sum_{|\mb{k}|<\Lambda^*\atop{\mb{q}\neq \mb{k}}}\rr{\ket{\ua_d}\ket{\da_\mb{k}} \otimes s^z_k\ket{s^z_\mb{q}=-\fr{1}{2}}- \ket{\da_d}\ket{\ua_\mb{k}}\otimes s^z_k\ket{s^z_\mb{q}=\fr{1}{2}}}\\
					      &=-J_q \sum_{|\mb{k}|<\Lambda^*\atop{\mb{q}\neq \mb{k}}}\rr{\ket{\ua_d}\ket{\da_\mb{k}} \otimes \ket{s^z_\mb{q}=-\fr{1}{2}}- \ket{\da_d}\ket{\ua_\mb{k}}\otimes \ket{s^z_\mb{q}=\fr{1}{2}}}\\
					      &=-J_q \ket{\Psi^*}
\eeq
\beq
S^z s^z\ket{\Psi^*} &= \sum_{|\mb{k}|<\Lambda^*\atop{\mb{q}\neq \mb{k}}}\rr{S^z \ket{\ua_d}s^z\ket{\da_\mb{k}} \otimes \ket{s^z_\mb{q}=-\fr{1}{2}}- S^z\ket{\da_d}s^z\ket{\ua_\mb{k}}\otimes \ket{s^z_\mb{q}=\fr{1}{2}}}\\
		    &= -N_\text{shell}\ket{\Psi^*}
\eeq
\beq
\rr{S^+ s^- + S^- s^+}\ket{\Psi^*} &= \sum_{|\mb{k}|<\Lambda^*\atop{\mb{q}\neq \mb{k}}}\rr{S^- \ket{\ua_d}s^+\ket{\da_\mb{k}} \otimes \ket{s^z_\mb{q}=-\fr{1}{2}}- S^+\ket{\da_d}s^-\ket{\ua_\mb{k}}\otimes \ket{s^z_\mb{q}=\fr{1}{2}}}\\
		    &= -N_\text{shell}\ket{\Psi^*}
\eeq
Therefore,
\beq
