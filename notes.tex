...
\beq
\ham = \sum_{k\sigma}\epsilon_k \hat n_{k\sigma} + \sum_{k\sigma} \rr{V_{k} c^\dagger_{k\sigma} c_{d\sigma} + h.c.} + \epsilon_{d}\sum_\sigma  \hat n_{d\sigma} +  U \hat n_{d\ua} \hat n_{d\da} + \sum_{kk^\prime\atop{\sigma\sigma^\prime}}V_2c^\dagger_{k\sigma}c^\dagger_{d\sigma^\prime}c_{d\sigma}c_{k^\prime\sigma^\prime}
\eeq
...
\beq
\ham_N = H_0 + H_\text{imp} + \epsilon_q \hat n_{q\beta} + V_q c^\dagger_{q\beta}c_{d\beta} + V^*_q c^\dagger_{d\beta}c_{q\beta} + \sum_{k\sigma}V_2\rr{c^\dagger_{q\beta}c^\dagger_{d\sigma}c_{d\beta}c_{k\sigma} + c^\dagger_{k\sigma}c^\dagger_{d\beta}c_{d\sigma}c_{q\beta}}\\
...
\beq
	      ...
	      &=\sum_{q k\sigma} V_qV_2 c_{d\sigma}c^\dagger_{k\sigma} \qq{\fr{2}{\omega - \epsilon_d - \epsilon_q} + \hat n_{d\ol\sigma}\fr{3\epsilon_d + \epsilon_q - \omega}{\omega - 2\epsilon_d - \epsilon_q}}\\
	      &=\sum_{q k\sigma} V_qV_2 c^\dagger_{k\sigma} c_{d\sigma}\qq{\fr{-2}{\omega - \epsilon_d - \epsilon_q} - \hat n_{d\ol\sigma}\fr{3\epsilon_d + \epsilon_q - \omega}{\omega - 2\epsilon_d - \epsilon_q}}
\eeq
...
\beq
	      ...
	      &=\sum_{kk^\prime q\sigma\sigma^\prime}V^2_2 c_{k\sigma}c^\dagger_{d\sigma}c_{d\sigma^\prime}c^\dagger_{k^\prime\sigma^\prime} \qq{\fr{2}{\omega - \epsilon_d - \epsilon_q} + \hat n_{d\ol\sigma^\prime}\fr{3\epsilon_d + \epsilon_q - \omega}{\omega - 2\epsilon_d - \epsilon_q}}\\
	      &=\sum_{kq\sigma}V^2_2\hat n_{d\sigma} \qq{\fr{2}{\omega - \epsilon_d - \epsilon_q} + \hat n_{d\ol\sigma}\fr{3\epsilon_d + \epsilon_q - \omega}{\omega - 2\epsilon_d - \epsilon_q}}\\
	      &- \sum_{kk^\prime q\sigma\sigma^\prime}V^2_2 c^\dagger_{k^\prime\sigma^\prime}c^\dagger_{d\sigma}c_{d\sigma^\prime} c_{k\sigma}\qq{\fr{2}{\omega - \epsilon_d - \epsilon_q} + \hat n_{d\ol\sigma^\prime}\fr{3\epsilon_d + \epsilon_q - \omega}{\omega - 2\epsilon_d - \epsilon_q}}
\eeq
