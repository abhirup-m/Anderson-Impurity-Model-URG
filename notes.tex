...
\beq
\Delta V_k^+ &\approx -\hf n(D) V_1 V_2\fr{1}{\mc{W}}\\
	     &=\fr{V_1 V_2}{2 D_0 D}\Delta D &&\qq{\rho = \fr{1}{2D_0}}
\eeq
\beq
\Delta V_k^- &= -n(D) V_1 V_2\fr{1}{\mc{W} + \epsilon_d} \approx -n(D) V_1 V_2\fr{1}{\mc{W}}\\
	     &= \fr{V_1 V_2}{D_0 D}\Delta D
\eeq
\end{document}
