...
\eeq
From the work of Seki and Yunoki\footnote{Kazuhiro Seki and Seiji Yunoki. Topological interpretation of the luttinger theorem. Physical Review B, 96(8):085124, 2017}, we know that this quantity is essentially the winding number of the curve \il{\Gamma(D)} in the complex plane spanned by the real and imaginary parts of \il{D}, and is equal to the change in Luttinger's volume \il{V_L} at \il{T=0}.
\beq
