...
\beq
\avg{n_{d\sigma}} = \fr{1}{\pi}\tan^{-1} \fr{\Delta}{\epsilon_d + \Sigma(0,h)}
\eeq
Multiplying the numerator and denominator by \il{z}, we get the same occupancy in terms of the renormalised parameters.
\beq
\avg{n_{d\sigma}} = \fr{1}{\pi}\tan^{-1} \fr{\wl\Delta}{\wl\epsilon_d + \wl\Sigma(0,h)}
\eeq
