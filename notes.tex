...
\begin{itemize}
	\item For \(\omega^-_N - \hf\epsilon_0>0\), \(\epsilon_0\) is irrelevant. This will again lead to a runaway denominator, where \(\epsilon_0\) goes on decreasing and \(\omega^-_N\) goes on increasing such that the denominator goes on increasing and there is no way of making it 0.
	\item For \(\omega^-_N - \hf\epsilon_0<0\), \(\epsilon_0\) is relevant, so \(\epsilon_0\) will increase and \(\omega_N^-\) will decrease, so the denominator will never be zero.
\end{itemize}
