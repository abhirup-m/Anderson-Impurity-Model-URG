...
\beq
H_1 &= \ham_0 + \hf \cc{\ham_0, S^2} - S \ham_0 S + \qq{S,\ham_X}\\
...
\eeq
The total renormalization, minus the potential scattering and constant terms, is
\beq
2\sum_{kq}J_{kq}\qq{S_d^z s^z_{kq} + \hf\rr{S_d^+ s_{kq}^- + S_d^- s_{kq}^+}} = 2\sum_{kq}J_{kq}\vec{S}_d\cdot\vec{s}_{kq}
\eeq
...
\beq
\sum_{kq\sigma}V_qV_k c^\dagger_{q\ol\sigma}c_{d\ol\sigma}c^\dagger_{k\sigma}c_{d\sigma}\frac{1}{\epsilon_d + U - \epsilon_k}
\eeq
The second scattering term becomes
\beq
V_{1 \to 2}\frac{1}{E - \ham_0 - \epsilon_d}V_{0\to 1} &= \sum_{kq\sigma\gamma}V_q^* c^\dagger_{d\gamma}c_{q\gamma}\hat n_{d\ol\gamma}\frac{1}{E - \ham_0 - \epsilon_d}V_k^* c^\dagger_{d\sigma}c_{k\sigma}\rr{1 - \hat n_{d\ol\sigma}}\\
						       &=\sum_{kq\sigma\gamma}V_q^* c^\dagger_{d\gamma}c_{q\gamma}\hat n_{d\ol\gamma}V_k^* c^\dagger_{d\sigma}c_{k\sigma}\rr{1 - \hat n_{d\ol\sigma}}\frac{1}{\epsilon_k - \epsilon_d}\\
\eeq
