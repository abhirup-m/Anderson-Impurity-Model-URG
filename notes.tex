...
\cc{\ham_0^*,\qq{\ham^*_0, s^-}} &= \sum_{k,\sigma,k_1 k_2}\rr{\epsilon_{k_1} - \epsilon_{k_2}}\cc{n_{k\sigma},c^\dagger_{k_1\da}c_{k_2\da}}
\eeq
...
\implies \cc{n_{k\sigma},c^\dagger_{k_1\da}c_{k_2\ua}} &= \qq{\rr{\delta_{kk_2}\delta_{\sigma\ua} - \delta_{kk_1}\delta_{\sigma\da}} + 2n_{k\sigma}}c^\dagger_{k_1\da}c_{k_2\da}
\eeq
Therefore,
\beq
\cc{\ham_0^*,\qq{\ham^*_0, s^-}} &= \sum_{k,\sigma,k_1 k_2}\rr{\epsilon_{k_1} - \epsilon_{k_2}} \qq{\rr{\delta_{kk_2}\delta_{\sigma\ua} - \delta_{kk_1}\delta_{\sigma\da}}c^\dagger_{k_1\da}c_{k_2\ua} + 2n_{k\sigma}c^\dagger_{k_1\da}c_{k_2\ua}}\\
				 &=2n(0)\sum_{k_1 k_2}\rr{\epsilon_{k_1} - \epsilon_{k_2}} c^\dagger_{k_1\da}c_{k_2\ua}\\
\implies s^+\cc{\ham_0^*,\qq{\ham^*_0, s^-}} &= 2n(0)\sum_{k_1 k_2 k_3 k_4}\rr{\epsilon_{k_1} - \epsilon_{k_2}} c^\dagger_{k_3\ua}c_{k_4\da}c^\dagger_{k_1\da}c_{k_2\ua}\\
\eeq
This gives
\beq
-\fr{16}{{J^*}}s^+{\ham^*_0}^2s^- &= -\fr{16}{J^*}{\ham_0^*}^2 -\fr{16}{J^*} 2n(0)\sum_{k_1 k_2 k_3 k_4}\rr{\epsilon_{k_1} -\epsilon_{k_2}} c^\dagger_{k_3\ua}c_{k_4\da}c^\dagger_{k_1\da}c_{k_2\ua}
\eeq
