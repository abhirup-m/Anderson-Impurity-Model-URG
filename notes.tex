...
\beq
\hf \hat n_{q\beta}\fr{1}{\hat \omega - \rr{H_\text{imp} + V_2 \hat n_{d\beta} + \epsilon_q}\hat n_{q\beta}} &= \hf \hat n_{q\beta}\fr{1}{\omega \hat n_{q\beta} - \rr{H_\text{imp} + V_2 \hat n_{d\beta} + \epsilon_q}\hat n_{q\beta}}\\
...
&= \sum_{q\beta}\tau_{q\beta}\fr{1}{\hat \omega - \rr{H_{imp} - \epsilon_q}\rr{1 - \hat n_{q\beta} }} c^\dagger_{d\beta}\qq{V^*_q - \sum_{k^\prime\sigma^\prime} V_2 c_{d\sigma^\prime}c^\dagger_{k^\prime\sigma^\prime}}c_{q\beta} c^\dagger_{q\beta}\qq{V_q - \sum_{k\sigma}V_2 c_{k\sigma}c^\dagger_{d\sigma}}c_{d\beta}\\
...
-\hf\sum_{q\beta}&\fr{1}{\omega + H_{imp} + \epsilon_q } |V_q|^2 \hat n_{d\beta} \\
	     ...
	     &=-\hf\sum_{q\beta} \fr{\hat n_{d\beta}|V_q|^2}{\omega - \epsilon_d + \epsilon_q} -\hf \hat n_{d\ua}\hat n_{d\da}\sum_{q}\fr{2|V_q|^2\rr{\epsilon_d + U}}{\rr{\omega - \rr{2\epsilon_d + U} + \epsilon_q}\rr{\omega - \epsilon_d + \epsilon_q}}
\eeq
The second term gives
\beq
