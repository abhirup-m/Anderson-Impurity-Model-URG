...
\eeq
Since \il{\tau_{q\beta}c_{q\beta}c^\dagger_{q\beta} = -\hf\rr{1-\hat n_{q\beta}} = -\hf}, we get
\beq
\Delta \ham_N &= \fr{-1}{2}\sum_{q\beta}c^\dagger_{d\beta}\qq{V^*_q + \sum_{k^\prime\sigma^\prime} V_2 c^\dagger_{k^\prime\sigma^\prime}c_{d\sigma^\prime}}\fr{1}{\omega - \rr{H_\text{imp} + V_2 \hat n_{d\beta} + \fr{\epsilon_q}{2}}} \qq{V_q + \sum_{k\sigma}V_2 c^\dagger_{d\sigma}c_{k\sigma}}c_{d\beta}
\eeq
...
The intermediate state consists of hole states, obtained by exciting electrons from the lower bandwith edge (\il{-D}).
\beq
...
\eeq
The Green's functon simplifies as
\beq
...
\Delta U = -\sum_q\fr{|V_q|^2\epsilon_d}{\rr{\omega - \hf\epsilon_q - \epsilon_d}\rr{\omega - \hf\epsilon_q}} - \sum_q \fr{\epsilon_d + U}{\rr{\omega - \hf\epsilon_q + 2\epsilon_d + U}\rr{\omega - \hf\epsilon_q + \epsilon_d}}
\end{gather}
\paragraph{Sanity Checks: \il{\omega = D} }
\paragraph{1.  \il{\epsilon_d,U+\epsilon_d \ll D}}
\beq
\Delta \epsilon_d &= -\hf n(D)|V_1|^2\fr{1}{\omega - \hf D} + \hf n(D)|V_1|^2\fr{\omega - \hf D + 3\epsilon_d + 2U}{\rr{\omega - \hf D + 2\epsilon_d + U}\rr{\omega - \hf D + \epsilon_d}}\\
&= -\hf n(D)|V_1|^2\fr{1}{\hf D} + \hf n(D)|V_1|^2\fr{\hf D + 3\epsilon_d + 2U}{\rr{\hf D + 2\epsilon_d + U}\rr{\hf D + \epsilon_d}}\\
&\approx -\hf n(D)|V_1|^2\fr{1}{\hf D} + \hf n(D)|V_1|^2\fr{1}{\hf D + \epsilon_d}\\
&\approx -\hf n(D)|V_1|^2\fr{1}{\hf D} + \hf n(D)|V_1|^2\fr{1}{\hf D}\\
&=0
\eeq
\beq
\Delta U &= - n(D)|V_1|^2\fr{\epsilon_d}{\rr{\hf D - \epsilon_d}\rr{\hf D}} - n(D)|V_1|^2 \fr{\epsilon_d + U}{\rr{\hf D + 2\epsilon_d + U}\rr{\hf D + \epsilon_d}}\\
	 &= - n(D)|V_1|^2\qq{\fr{1}{\hf D - \epsilon_d}- \fr{1}{\hf D}} - n(D)|V_1|^2 \qq{\fr{1}{\hf D + \epsilon_d} - \fr{1}{\hf D + 2\epsilon_d + U}}\\
	 &\approx - n(D)|V_1|^2\qq{\fr{1}{\hf D}- \fr{1}{\hf D}} - n(D)|V_1|^2 \qq{\fr{1}{\hf D} - \fr{1}{\hf D}}\\
	 &= 0
\eeq
\paragraph{2. \il{U+\epsilon_d \gg D \gg \epsilon_d}}

\beq
\Delta \epsilon_d &= -\hf n(D)|V_1|^2\fr{1}{\hf D} + \hf n(D)|V_1|^2\fr{\hf D + 3\epsilon_d + 2U}{\rr{\hf D + 2\epsilon_d + U}\rr{\hf D + \epsilon_d}}\\
&\approx -\hf n(D)|V_1|^2\fr{1}{\hf D} + \hf n(D)|V_1|^2\fr{2U}{\rr{U}\rr{\hf D}}\\
&= -n(D)|V_1|^2\fr{1}{D} + 2n(D)|V_1|^2\fr{1}{D}\\
&= n(D)|V_1|^2\fr{1}{D}\\
&= -\fr{\Delta}{\pi}\fr{\Delta D}{D}\\
\implies \dv{\epsilon_d}{\ln D} + \fr{\Delta}{\pi} &= 0
\eeq
\beq
\Delta U &= - n(D)|V_1|^2\qq{\fr{1}{\hf D - \epsilon_d}- \fr{1}{\hf D}} - n(D)|V_1|^2 \qq{\fr{1}{\hf D + \epsilon_d} - \fr{1}{\hf D + 2\epsilon_d + U}}\\
	 &\approx - n(D)|V_1|^2\qq{\fr{1}{\hf D}- \fr{1}{\hf D}} - n(D)|V_1|^2 \qq{\fr{1}{\hf D} - \fr{1}{\epsilon_d + U}}\\
	 &\approx -n(D)|V_1|^2 \qq{\fr{2}{D} - \fr{1}{\epsilon_d + U}}\\
\eeq
\end{document}
