...
\pb A similar flow happens if we start from the free orbital fixed point. There, \(U\) is 0, and the equations look like
\begin{flalign*}
...
\caption{Schematic flows from local moment and free orbital to strong-coupling}
\label{schemesc}
\end{figure}
