...
&= \wl{H}^D_0 + \epsilon_2 + 2|V_1|^2\tau_1\text{Tr}_2\cc{c_1^\dagger c_{d\sigma_1}, c^\dagger_{d\sigma_1}c_1 \fr{1}{ \omega - \rr{\epsilon_d \hat n_{d\sigma_1} + \epsilon_2 \hat n_2 + \epsilon_1}}}\\
&= \wl{H}^D_0 + \epsilon_2 + 2|V_1|^2\tau_1\cc{c_1^\dagger c_{d\sigma_1}, c^\dagger_{d\sigma_1}c_1} \text{Tr}_2\qq{\fr{1}{ \omega - \rr{\epsilon_d \hat n_{d\sigma_1} + \epsilon_2 \hat n_2 + \epsilon_1}}}\\
&= \wl{H}^D_0 + \epsilon_2 + |V_1|^2\rr{\hat n_1 - \hat n_{d\sigma_1}} \qq{\fr{1}{ \omega - \rr{\epsilon_d \hat n_{d\sigma_1} + \epsilon_1}} + \fr{1}{ \omega - \rr{\epsilon_{d} \hat n_{d\sigma_1} + \epsilon_2 + \epsilon_1}}}\\
...
\eeq
\beq
\tau_{2}\cc{c^\dagger_{2}\text{Tr}_{2}\rr{\ham_{1} c_{2}},\eta_{2}} &= \tau_2 |V_2|^2\cc{c^\dagger_2 c_{d\sigma_2},c^\dagger_{d\sigma_2}c_2\fr{1}{\hat \omega^\prime - \qq{\wl{H}^D_0 + \epsilon_2 + \rr{\hat n_1 - \hat n_{d\sigma_1}} A(\omega)}\hat n_2}}\\
								    &= 2\tau_2 \fr{1}{\hat \omega^\prime - \qq{\wl{H}^D_0 + \epsilon_2 + A(\omega)\rr{\hat n_1 - \hat n_{d\sigma_1}}}}|V_2|^2\cc{c^\dagger_2 c_{d\sigma_2},c^\dagger_{d\sigma_2}c_2}\\
				    &= \fr{1}{\hat \omega^\prime - \qq{\wl{H}^D_0 + \epsilon_2 + A(\omega)\rr{\hat n_1 - \hat n_{d\sigma_1}}}}|V_2|^2\qq{\hat n_2 - \hat n_{d\sigma_2}}
\eeq
...
where
\beq
H_0 = \sum_{k<\Lambda_N,\sigma}\rr{\epsilon_k \hat n_{k\sigma} + V_k c^\dagger_{k\sigma}c_{d\sigma} + \text{h.c.}} + \sum_\sigma \epsilon_d \hat n_{d\sigma} + U \hat n_{d\ua}\hat n_{d\da}
\eeq
and
\beq
H_{i>0} = \epsilon_k \hat n_{k\beta_i} + V_k c^\dagger_{k\beta_i}c_{d\beta_i} + \text{h.c.}
\eeq
The first rotated Hamiltonian is
\beq
\ham_1 = H_0 + H_2 + H_3 + \hf\rr{\tau_1 + 1}\epsilon_1 + |V_1|^2\cc{c_1^\dagger c_{d\sigma_1}, c^\dagger_{d\sigma_1}c_1 \fr{1}{\hat \omega - \rr{\ham_0^D + \epsilon_2 \hat n_2 + \epsilon_3 \hat n_3 + \epsilon_1}\hat n_1}}
\eeq
We can write this thing as
\beq[ham2]
\ham_1 = \wl{H_0} + \epsilon_2 \hat n_2 + |V_1|^2\cc{c_1^\dagger c_{d\sigma_1}, c^\dagger_{d\sigma_1}c_1 \fr{1}{\hat \omega - \rr{\ham_0^D + \epsilon_2 \hat n_2 + \epsilon_3 \hat n_3 + \epsilon_1}\hat n_1}} + V_2 c^\dagger_2 c_{d\sigma_2} + \text{h.c.}
\eeq
where the first term \il{\wl{H_0} = H_0 + H_3 + \hf\rr{\tau_1 + 1}\epsilon_1} is the part without any 2, the second and third terms are diagonal in 2 and the final terms cause number fluctuations in 2.
The next Hamiltonian is
\beq
\ham_{2,1} = \hf\text{Tr}_{2}\ham_1 + \tau_2\text{Tr}_2\rr{\ham_1 \tau_2} +\tau_{2}\cc{c^\dagger_{2}\text{Tr}_{2}\rr{\ham_1 c_{2}},\eta_{2}}
\eeq
Applying this on the Hamiltonian eq.~\ref{ham2} will give:
\beq
\hf\text{Tr}_{2}\ham_1 &= \wl{H_0} + \hf\epsilon_2 + \hf|V_1|^2\text{Tr}_{2}\cc{c_1^\dagger c_{d\sigma_1}, c^\dagger_{d\sigma_1}c_1 \fr{1}{\hat \omega - \rr{\ham_0^D + \epsilon_2 \hat n_2 + \epsilon_3 \hat n_3 + \epsilon_1}\hat n_1}}\\
&= \wl{H_0} + \hf\epsilon_2 + \hf|V_1|^2\cc{c_1^\dagger c_{d\sigma_1}, c^\dagger_{d\sigma_1}c_1 \fr{1}{\hat \omega - \rr{\ham_0^D + \epsilon_2 + \epsilon_3 \hat n_3 + \epsilon_1}\hat n_1}}\\
&+ \hf|V_1|^2\cc{c_1^\dagger c_{d\sigma_1}, c^\dagger_{d\sigma_1}c_1 \fr{1}{\hat \omega - \rr{\ham_0^D + \epsilon_3 \hat n_3 + \epsilon_1}\hat n_1}}\\
\eeq
\beq
\tau_2\text{Tr}_2\rr{\ham_1 \tau_2} &= \tau_2\text{Tr}_2\rr{\epsilon_2 \hat n_2 \tau_2+ |V_1|^2\cc{c_1^\dagger c_{d\sigma_1}, c^\dagger_{d\sigma_1}c_1 \fr{1}{\hat \omega - \rr{\ham_0^D + \epsilon_2 \hat n_2 + \epsilon_3 \hat n_3 + \epsilon_1}\hat n_1}}\tau_2}\\
				    &= \hf\epsilon_2\tau_2 + \hf|V_1|^2\tau_2\cc{c_1^\dagger c_{d\sigma_1}, c^\dagger_{d\sigma_1}c_1 \fr{1}{\hat \omega - \rr{\ham_0^D + \epsilon_2 + \epsilon_3 \hat n_3 + \epsilon_1}\hat n_1}}\\
				    &- \hf|V_1|^2\tau_2\cc{c_1^\dagger c_{d\sigma_1}, c^\dagger_{d\sigma_1}c_1 \fr{1}{\hat \omega - \rr{\ham_0^D + \epsilon_3 \hat n_3 + \epsilon_1}\hat n_1}}
\eeq
\beq
\tau_{2}\cc{c^\dagger_{2}\text{Tr}_{2}\rr{\ham_1 c_{2}},\eta_{2}} &= |V_2|^2 \tau_{2}\cc{c^\dagger_{2}c_{d\sigma_2},c^\dagger_{d\sigma_2}c_2 \fr{1}{\hat \omega - \rr{\ham_0^D + \epsilon_1 \hat n_1 + \epsilon_3 \hat n_3 + \epsilon_2}\hat n_2}}
\eeq
