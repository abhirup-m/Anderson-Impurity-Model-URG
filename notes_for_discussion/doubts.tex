...
\end{equation*}
\begin{equation*}
	H(B) = J \vec{S_d}\cdot\vec{s} + B S_d^z,
\end{equation*}
\begin{equation*}
...
\begin{equation*}
	\chi_\text{imp} = \chi(J) - \chi(J=0) + \frac{1}{4}
\end{equation*}
which would require
\begin{equation*}
	H(B) = \sum_k \epsilon_k \hat n_{k\sigma} + J \vec{S_d}\cdot\vec{s} + J^\prime S_d^z s^z + B S_d^z + B \mu_B \left(\hat n_{d \uparrow} - \hat n_{d \downarrow}\right) 	
\end{equation*}
