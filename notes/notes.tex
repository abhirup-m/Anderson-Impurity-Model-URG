...
\end{aligned}\end{equation}
On the other hand, in the third quadrant, we have \(\frac{3k}{4} + \epsilon_d - \frac{3j}{4} > 0\), and the theta function will give 0.
\begin{equation}\begin{aligned}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[scale=0.5]{../figures/chi_T.pdf}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[scale=0.5]{../figures/chi.pdf}
