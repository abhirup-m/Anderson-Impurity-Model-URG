...
\begin{figure}[htpb]
	...
	\label{crossover}
\end{figure}
\pb We have also checked that the fixed point values of \(J\) and \(V\) go on increasing as we increase the system size.
\begin{figure}[htpb]
	\centering
...
\end{aligned}\end{equation}
%The susceptibility takes a simpler form for the case of \(\epsilon_d = k =0\):
%\begin{equation}\begin{aligned}
%	\chi(\beta) = \frac{\left[4 + 2e^{-\beta \frac{j}{2}}\right] \frac{1}{4}\beta + e^{\beta\frac{j}{4}} \sinh \left(\beta \frac{j}{2} \right) \frac{1}{j}}{12 + 2e^{-\beta \frac{j}{2}} + 2e^{\beta\frac{j}{4}}\cosh \left(\beta \frac{j}{2}\right)}\\
%\end{aligned}\end{equation}
\begin{figure}[htpb!]
	\centering
...
%\begin{figure}[htpb]
%	\centering
%	\includegraphics[scale=0.38]{../figures/chi.pdf}
%	\caption{Variation of $\chi$ against temperature.}
%\end{figure}
%\begin{figure}[htpb]
%	\centering
...
%\end{figure}
\pb If we do not ignore the hybridisation \(v\), then finding the eigenvalues in the presence of a magnetic field boils down to diagonalizing a \(3\times3\) subspace involving the three eigenstates \(\ket{\pm}\) and the spin triplet. We will represent these states and their eigenvalues by the following shorthand notation:
\begin{equation}\begin{aligned}
...
\begin{equation}\begin{aligned}
	&E_- + v\\
	&= v\left[ \gamma - \sqrt{\gamma^2 + 4} \right] + \epsilon_d - \frac{3}{4}j + v\\
...
\subsection{Effective Hamiltonian for excitations of the Kondo cloud}
...
\begin{equation}\begin{aligned}
	\textcolor{red}{c_{2 \downarrow}a_2^\uparrow} &= -\frac{V \lambda}{E_g}c_{2 \downarrow}\left[ 1 + \frac{1}{E_g}\left(H_0^* \right) + \frac{1}{E_g^2}\left(H_0^* \right)^2\right] c^\dagger_{2\downarrow}\\
				     &= -\frac{V \lambda}{E_g}\left[c_{2 \downarrow} + \frac{1}{E_g}\left(H_0^* \right)c_{2 \downarrow} + \sum_k \frac{\epsilon_k}{\sqrt{N^*}}c_{k\downarrow} + \frac{1}{E_g^2}\left(H_0^* \right)^2c_{2 \downarrow} + \sum_k \frac{\epsilon^2_k}{\sqrt{N^*}}c_{k\downarrow}\right]c^\dagger_{2\downarrow}\\
				     &= -\frac{V \lambda}{E_g}\left[1 + \frac{H_0^*}{E_g} + \left(\frac{H_0^*}{E_g}\right)^2\right]c_{2 \downarrow}c^\dagger_{2\downarrow} - \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)c_{k\downarrow}c^\dagger_{k^\prime\downarrow}\\
	\textcolor{green}{c_{2 \uparrow}a_2^\downarrow }&= -\frac{V \lambda}{E_g}\left[1 + \frac{H_0^*}{E_g} + \left(\frac{H_0^*}{E_g}\right)^2\right]c_{2 \uparrow}c^\dagger_{2\uparrow} - \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)c_{k\uparrow}c^\dagger_{k^\prime\uparrow}\\
	\textcolor{red}{c^\dagger_{2 \uparrow}a_0^\uparrow} &= c^\dagger_{2 \uparrow} \frac{V \lambda}{E_g}\left[ 1 + \frac{1}{E_g}\left(H_0^* \right) + \frac{1}{E_g^2}\left(H_0^* \right)^2\right] c_{2 \uparrow}\\
					   &= \frac{V \lambda}{E_g}\left[1 + \frac{H_0^*}{E_g} + \left(\frac{H_0^*}{E_g}\right)^2\right]c^\dagger_{2 \uparrow}c_{2\uparrow} - \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)c^\dagger_{k\uparrow}c_{k^\prime\uparrow}\\
	\textcolor{green}{c^\dagger_{2 \downarrow}a_0^\downarrow} &= \frac{V \lambda}{E_g}\left[1 + \frac{H_0^*}{E_g} + \left(\frac{H_0^*}{E_g}\right)^2\right]c^\dagger_{2 \downarrow}c_{2\downarrow} - \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)c^\dagger_{k\downarrow}c_{k^\prime\downarrow}\\
	\textcolor{blue}{c_{2 \downarrow}a_2^\downarrow }&= \frac{V \lambda}{E_g}c_{2 \downarrow}\left[ 1 + \frac{1}{E_g}\left(H_0^* \right) + \frac{1}{E_g^2}\left(H_0^* \right)^2\right] c^\dagger_{2\uparrow}\\
				       &=\frac{V \lambda}{E_g}\left[1 + \frac{1}{E_g}\left(H_0^* \right)\right]c_{2 \downarrow}c^\dagger_{2\uparrow} + \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon^2_k\right)c_{k\downarrow}c^\dagger_{k^\prime\uparrow}\\
	\textcolor{yellow}{c_{2 \uparrow}a_2^\uparrow} &=-\frac{V \lambda}{E_g}\left[1 + \frac{1}{E_g}\left(H_0^* \right)\right]c_{2 \uparrow}c^\dagger_{2\downarrow} - \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon^2_k\right)c_{k\uparrow}c^\dagger_{k^\prime\downarrow}\\
	\textcolor{blue}{c^\dagger_{2 \uparrow}a_0^\downarrow }&= \frac{V \lambda}{E_g}\left[1 + \frac{H_0^*}{E_g}\right]c^\dagger_{2 \uparrow}c_{2\downarrow} - \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)c^\dagger_{k\uparrow}c_{k^\prime\downarrow}\\
	\textcolor{yellow}{c^\dagger_{2 \downarrow}a_0^\uparrow} &= \frac{V \lambda}{E_g}\left[1 + \frac{H_0^*}{E_g}\right]c^\dagger_{2 \downarrow}c_{2\uparrow} - \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)c^\dagger_{k\downarrow}c_{k^\prime\uparrow}\\
\textcolor{red}{c_{2 \downarrow}a_2^\uparrow - c^\dagger_{2 \uparrow}a_0^\uparrow} &= -\frac{V \lambda}{E_g}\left[1 + \frac{H_0^*}{E_g} + \left(\frac{H_0^*}{E_g}\right)^2\right]\times 2 + \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)\left(c^\dagger_{k\uparrow}c_{k^\prime\uparrow} - c_{k\downarrow}c^\dagger_{k^\prime\downarrow}\right)\\
\textcolor{blue}{c_{2 \downarrow}a_2^\downarrow - c^\dagger_{2 \uparrow}a_0^\downarrow }&= \frac{V \lambda}{E_g}\left[1 + \frac{1}{E_g}\left(H_0^* \right)\right]c_{2 \downarrow}c^\dagger_{2\uparrow} \times 2 + \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)\left(c_{k\downarrow}c^\dagger_{k^\prime\uparrow} + c^\dagger_{k\uparrow}c_{k^\prime\downarrow}\right)\\
\textcolor{green}{c^\dagger_{2 \downarrow}a_0^\downarrow - c_{2 \uparrow}a_2^\downarrow} &= \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)\left(c_{k\uparrow}c^\dagger_{k^\prime\uparrow} - c^\dagger_{k\downarrow}c_{k^\prime\downarrow}\right)\\
\textcolor{yellow}{c^\dagger_{2 \downarrow}a_0^\uparrow - c_{2 \uparrow}a_2^\uparrow} &= \frac{V \lambda}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)\left(c_{k\uparrow}c^\dagger_{k^\prime\downarrow} - c^\dagger_{k\downarrow}c_{k^\prime\uparrow}\right)
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	&H_0^* - \frac{J}{2}s^z -\frac{2V^2}{E_g}\left[1 + \frac{H_0^*}{E_g} + \left(\frac{H_0^*}{E_g}\right)^2\right] + \frac{V^2 }{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)\left(c^\dagger_{k\uparrow}c_{k^\prime\uparrow} - c_{k\downarrow}c^\dagger_{k^\prime\downarrow}\right) \\
	&+ \left[ \frac{V}{\lambda}\left(c_{2 \downarrow}a_2^\downarrow - c^\dagger_{2 \uparrow}a_0^\downarrow\right)\right] \frac{1}{A^J_- - \frac{V^2}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)\left(c_{k\uparrow}c^\dagger_{k^\prime\uparrow} - c^\dagger_{k\downarrow}c_{k^\prime\downarrow}\right) }\left[\frac{V}{\lambda}\left( c^\dagger_{2 \downarrow}a_0^\uparrow - c_{2 \uparrow}a_2^\uparrow\right)\right]\\
	&+ \left[ \frac{V}{\lambda}\left(c_{2 \downarrow}a_2^\downarrow - c^\dagger_{2 \uparrow}a_0^\downarrow\right) \right] \frac{1}{A^J_- - \frac{V^2}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)\left(c_{k\uparrow}c^\dagger_{k^\prime\uparrow} - c^\dagger_{k\downarrow}c_{k^\prime\downarrow}\right) }\left[ - \frac{J}{2}s^-\right]\\
	&+ \left[- \frac{J}{2}s^+ \right] \frac{1}{A^J_- - \frac{V^2}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)\left(c_{k\uparrow}c^\dagger_{k^\prime\uparrow} - c^\dagger_{k\downarrow}c_{k^\prime\downarrow}\right) }\left[\frac{V}{\lambda}\left( c^\dagger_{2 \downarrow}a_0^\uparrow - c_{2 \uparrow}a_2^\uparrow\right)\right]\\
	&+ \frac{J^2}{4}\left[s^+ \right] \frac{1}{A^J_- - \frac{V^2}{E_g N^*}\sum_{kk^\prime} \left(\epsilon_k + \epsilon_k^2\right)\left(c_{k\uparrow}c^\dagger_{k^\prime\uparrow} - c^\dagger_{k\downarrow}c_{k^\prime\downarrow}\right) }\left[s^-\right]\\
\end{aligned}\end{equation}
We first consider only zeroth order terms of the central propagator. Defining \(\xi_k = \epsilon_k + \epsilon_k^2\), we get
\begin{equation}\begin{aligned}
	&H_0^* - \frac{J}{2}s^z -\frac{2V^2}{E_g}\left[1 + \frac{H_0^*}{E_g} + \left(\frac{H_0^*}{E_g}\right)^2\right] + \frac{V^2 }{E_g N^*}\sum_{kk^\prime} \left(\xi_k \right)\left(c^\dagger_{k\uparrow}c_{k^\prime\uparrow} - c_{k\downarrow}c^\dagger_{k^\prime\downarrow}\right) \\
	&+ \frac{V^4}{E^2_g {N^*}^2 \left( E_g + \frac{J}{4} \right) }\sum_{kk^\prime}\left[\left(2 + \xi_k \right) c_{k \downarrow}c^\dagger_{k^\prime\uparrow} + \left(\xi_k \right)c^\dagger_{k\uparrow}c_{k^\prime\downarrow}\right]\sum_{kk^\prime} \left(\xi_k \right)\left(c_{k\uparrow}c^\dagger_{k^\prime\downarrow} - c^\dagger_{k\downarrow}c_{k^\prime\uparrow}\right)\\
	&- \frac{V^2 J}{2E_g \left( E_g + \frac{J}{4} \right){N^*}}\sum_{kk^\prime}\left[\left(2 + \xi_k \right) c_{k \downarrow}c^\dagger_{k^\prime\uparrow} + \left(\xi_k \right)c^\dagger_{k\uparrow}c_{k^\prime\downarrow}\right]\sum_{kk^\prime}c^\dagger_{k \downarrow}c_{k^\prime \uparrow}\\
	&- \frac{JV^2}{2E_g \left( E_g + \frac{J}{4} \right)N^*} \sum_{kk^\prime}c^\dagger_{k \uparrow}c_{k^\prime \downarrow}\sum_{kk^\prime} \left(\xi_k \right)\left(c_{k\uparrow}c^\dagger_{k^\prime\downarrow} - c^\dagger_{k\downarrow}c_{k^\prime\uparrow}\right)\\
	&+ \frac{J^2}{4\left( E_g + \frac{J}{4} \right)}\sum_{kk^\prime}c^\dagger_{k \uparrow}c_{k^\prime \downarrow} \sum_{kk^\prime}c^\dagger_{k \downarrow}c_{k^\prime \uparrow}\\
\end{aligned}\end{equation}
We have set \(s^z = -\frac{1}{2}\) in the denominator, hence the \(E_g = \frac{J}{4}\). If we also consider the first order terms from the central propagator,
\begin{equation}\begin{aligned}
\end{aligned}\end{equation}
...
\end{aligned}\end{equation}
There we used \(\delta_\uparrow = \delta_\downarrow\) because the model is SU(2)-symmetric.
...
\begin{equation}\begin{aligned}
	\ket{\text{cloud}} = c_1\left[\ket{\uparrow^d}\frac{1}{\sqrt 2}\left(\ket{k_1 \downarrow} + \ket{ k_{-1} \downarrow}\right) - \ket{\downarrow^d}\frac{1}{\sqrt 2}\left(\ket{k_1 \uparrow} + \ket{ k_{-1} \uparrow}\right)\right] + c_2\left[\ket{2^d}\ket{0}\right.\\
...
\begin{equation}\begin{aligned}
	\ket{\Psi_0} =
	 \frac{1}{2}&\ket{0000} \otimes \ket{\uparrow^d}\ket{k_1 \downarrow, k_{-1} \downarrow} \otimes \ket{1111}\\
	 - \frac{1}{2}&\ket{0000} \otimes \ket{\downarrow^d}\ket{k_1 \uparrow, k_{-1} \uparrow} \otimes \ket{1111}\\
	 \frac{1}{2}&\ket{0000} \otimes \ket{2^d}\ket{0} \otimes \ket{1111}\\
	 - \frac{1}{2}&\ket{0000} \otimes \ket{0^d}\ket{k_1 \uparrow, k_1 \downarrow,k_{-1} \uparrow,k_{-1} \downarrow} \otimes \ket{1111}\\
...
\end{aligned}\end{equation}
 ...
 \ket{\hat n_{k_{2} \uparrow} = \hat n_{k_{2} \downarrow} = \hat n_{k_{3} \uparrow} = \hat n_{k_{3} \downarrow} = 0}
