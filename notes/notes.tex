...
\begin{flalign*}
	E^0_1 &= \frac{\epsilon_q}{2} + 2\epsilon_d + U - \frac{K_z}{2}\\
	E^0_2 &= \frac{\epsilon_q}{2} + \epsilon_d \\
	E^0_3 &= \frac{\epsilon_q}{2} + 2\epsilon_d + U\\
	E^0_4 &= \frac{\epsilon_q}{2}\\
	E^0_5 &= \frac{\epsilon_q}{2} + 2\epsilon_d + U - K_z\\
\end{flalign*}
\subsection{Hole sector}
...
\begin{equation}\begin{aligned}
	...
	E^1_2 &= \frac{\epsilon_q}{2} - \frac{K_z}{2}\\
	E^1_3 &= \frac{\epsilon_q}{2} + 2\epsilon_d + U\\
	E_4^1 &= \frac{\epsilon_q}{2}\\
...
\begin{flalign*}
	...
	\omega_2 &= -\frac{\epsilon_q}{2} - \frac{K_z}{2}\\
	\omega_3 &= -\frac{\epsilon_q}{2} + 2\epsilon_d + U\\
	\omega_4 &= -\frac{\epsilon_q}{2}\\
	\omega_5 &= -\frac{\epsilon_q}{2} - K_z\\
\end{flalign*}
Rewriting everything in terms of \(\omega = -\frac{\epsilon_q}{2} - \frac{K_z}{2}\) gives
\begin{equation}\begin{aligned}
	\omega_1 &= \omega + \epsilon_d + \frac{K_z}{2}\\
	\omega_2 &= \omega\\
	\omega_3 &= \omega + 2\epsilon_d + U + \frac{K_z}{2}\\
	\omega_4 &= \omega + \frac{K_z}{2}\\
	\omega_5 &= \omega - \frac{K_z}{2}\\
\end{aligned}\end{equation}
For the hole sector, we get
\begin{equation}\begin{aligned}
	\omega^\prime_1 &= -\frac{\epsilon_q}{2} + 2\epsilon_d + U - \frac{K_z}{2}\\
	\omega^\prime_2 &= -\frac{\epsilon_q}{2} + \epsilon_d - \frac{K_z}{2}\\
	\omega^\prime_3 &= -\frac{\epsilon_q}{2} + 2\epsilon_d + U \\
	\omega^\prime_4 &= -\frac{\epsilon_q}{2}\\
	\omega^\prime_5 &= -\frac{\epsilon_q}{2} + 2\epsilon_d + U - K_z\\
\end{aligned}\end{equation}
and, in terms of \(\omega\),
\begin{equation}\begin{aligned}
	\omega^\prime_1 &= \omega + 2\epsilon_d + U\\
	\omega^\prime_2 &= \omega + \epsilon_d\\
	\omega^\prime_3 &= \omega + 2\epsilon_d + U + \frac{K_z}{2}\\
	\omega^\prime_4 &= \omega + \frac{K_z}{2}\\
	\omega^\prime_5 &= \omega + 2\epsilon_d + U - \frac{K_z}{2}\\
\end{aligned}\end{equation}
The denominators can thus be written as
\begin{equation}\begin{aligned}
	\xi_1 &= \omega - \frac{\epsilon_q}{2} - \epsilon_d - U + K_z\\
	\xi_2 &= \omega - \frac{\epsilon_q}{2} - \epsilon_d\\
	\xi_3 &= \xi_4 = \xi_3^\prime = \xi_4^\prime = \omega - \frac{\epsilon_q}{2} + \frac{K_z}{2}\\
