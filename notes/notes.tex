...
\begin{center}
	\includegraphics[scale=0.52]{../siam-spin-num/af.png}
	\includegraphics[scale=0.52]{../siam-spin-num/ferro.png}
	\captionof{figure}{Left: Flow to the strong-coupling fixed point \(J^* > 0\). Right: Flow to the strong-coupling fixed point \(J^* = 0\)}
	\label{flows}
\end{center}
\begin{center}
...
\begin{center}
	\includegraphics[scale=0.38]{../siam-spin-num/ed_to_large1.png}
	\includegraphics[scale=0.38]{../siam-spin-num/ed_to_large2.png}
...
\end{center}
\begin{center}
	\includegraphics[scale=0.38]{../siam-spin-num/ed_to_zero1.png}
	\includegraphics[scale=0.38]{../siam-spin-num/ed_to_zero2.png}
...
\begin{minipage}{260pt}
\begin{center}
	\includegraphics[scale=0.6]{../siam-spin-num/J_vs_D_finite_w_both_log.png}
...
\begin{center}
	\includegraphics[scale=0.5]{../siam-charge-num/K_grow.png}
	\includegraphics[scale=0.5]{../siam-charge-num/K_decay.png}
...
\end{center}
\begin{center}
	\includegraphics[scale=0.46]{../siam-charge-num/ed_grow1.png}
	\includegraphics[scale=0.46]{../siam-charge-num/ed_grow2.png}
...
\end{center}
\begin{center}
	\includegraphics[scale=0.46]{../siam-charge-num/ed_decay1.png}
	\includegraphics[scale=0.46]{../siam-charge-num/ed_decay2.png}
...
\end{center}
\begin{center}
	\includegraphics[scale=0.5]{../siam-charge-num/K_vs_D.png}
