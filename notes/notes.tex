...
\begin{figure}[tbh!]
\begin{center}
	\includegraphics[scale=0.5]{../stargraph_num/not_zero1.png}
	\includegraphics[scale=0.5]{../stargraph_num/not_zero2.png}
...
\begin{figure}[tbh!]
\begin{center}
	\includegraphics[scale=0.5]{../stargraph_num/zero2.png}
	\includegraphics[scale=0.5]{../stargraph_num/zero1.png}
...
\begin{equation}\begin{aligned}
	\ham_X &= \underbrace{V_1^* c^\dagger_{d\beta}c_{q\beta}\hat n_{d\ol\beta}}_{T^\dagger_1} + \overbrace{V_0^* c^\dagger_{d\beta}c_{q\beta}\left(1 - \hat n_{d\ol\beta}\right)}^{T^\dagger_2} + \underbrace{\sum_{k<\Lambda_N}J^z_0 \hat n_{d\beta}\left(1 - \hat n_{d\ol\beta}\right) c^\dagger_{k\beta}c_{q\beta}}_{T^\dagger_3} \\
	       &+ \overbrace{\sum_{k<\Lambda_N}J^z_1 \hat n_{d\ol\beta}\left(1 - \hat n_{d\beta}\right) c^\dagger_{k\beta}c_{q\beta}}^{T^\dagger_4} + \underbrace{\sum_{k<\Lambda_N}J^t c^\dagger_{d\beta}c_{d\ol\beta}c^\dagger_{k\ol\beta}c_{q \beta}}_{T^\dagger_5} + \overbrace{J^t c^\dagger_{d\beta}c_{d\ol\beta}c^\dagger_{q\ol\beta}c_{q \beta}}^{T^\dagger_6} + \text{h.c.}
\end{aligned}\end{equation}
\subsection{Calculation of renormalization}
We will first look at the renormalization of \(\epsilon_d\), \(U\) and the interaction couplings for the lower shell electrons, so we can ignore \(T_6\) for the time-being. The generator will have five parts:
\begin{equation}
	\eta = \sum_{i=1}^5\frac{1}{\omega_i^0 - E_i^0}T^\dagger_i c_{q\beta}
\end{equation}
where
\begin{equation}\begin{aligned}
...
\end{aligned}\end{equation}
\comm{
	Looking at the operators \(T_i\), we can write
\begin{equation}\begin{aligned}
	E^0_1 &= - \frac{1}{2}\epsilon_q + 2\epsilon_d + U\\
	E^0_2 = E^0_3 = E^0_5 &= - \frac{1}{2}\epsilon_q + \epsilon_d - \frac{1}{2}J_z \hat n_{q\ol\beta}\\
	E^0_4 &= - \frac{1}{2}\epsilon_q + \epsilon_d + \frac{1}{2}J_z \hat n_{q\ol\beta}
\end{aligned}\end{equation}
The renormalization in the particle sector can be written as
\begin{equation}\begin{aligned}
		    \frac{1}{2}\sum_{ij} \left(\frac{1}{\omega - E^0_i} + \frac{1}{\omega - E^0_j}\right)\hat n T_i T_j^\dagger\\ 
\end{aligned}\end{equation}
We have assumed \(\omega_i^0 = \omega\). Now,
\begin{equation}\begin{aligned}
	\sum_{j} T_1 T_j^\dagger &= T_1 \left(T_1^\dagger+ T_4^\dagger + T_5^\dagger\right)\\
	\sum_{j} T_2 T_j^\dagger &= T_2 T_2^\dagger\\
	\sum_{j} T_3 T_j^\dagger &= T_3 T_3^\dagger\\
	\sum_{j} T_4 T_j^\dagger &= T_4 \left(T_1^\dagger+ T_4^\dagger + T_5^\dagger\right)\\
	\sum_{j} T_5 T_j^\dagger &= T_5 \left(T_1^\dagger+ T_4^\dagger + T_5^\dagger\right)\\
\end{aligned}\end{equation}
}
Therefore,
\begin{flalign}
		    &\sum_{ij} \left(\frac{1}{\omega - E^0_i} + \frac{1}{\omega - E^0_j}\right) T_i T_j^\dagger\\ 
		    &= \quad\left(\frac{1}{\omega - E^0_1} + \frac{1}{\omega - E^0_1}\right)T_1 T_1^\dagger+ \left(\frac{1}{\omega - E^0_1} + \frac{1}{\omega - E^0_4}\right)T_1 T_4^\dagger + \left(\frac{1}{\omega - E^0_1} + \frac{1}{\omega - E^0_5}\right)T_1 T_5^\dagger\\
		    &\quad+ \left(\frac{1}{\omega - E^0_2} + \frac{1}{\omega - E^0_2}\right)T_2 T_2^\dagger\\
		    &\quad+ \left(\frac{1}{\omega - E^0_3} + \frac{1}{\omega - E^0_3}\right)T_3 T_3^\dagger\\
		    &\quad+ \left(\frac{1}{\omega - E^0_4} + \frac{1}{\omega - E^0_1}\right)T_4 T_1^\dagger+ \left(\frac{1}{\omega - E^0_4} + \frac{1}{\omega - E^0_4}\right)T_4 T_4^\dagger + \left(\frac{1}{\omega - E^0_4} + \frac{1}{\omega - E^0_5}\right)T_4 T_5^\dagger\\
		    &\quad+ \left(\frac{1}{\omega - E^0_5} + \frac{1}{\omega - E^0_1}\right)T_5 T_1^\dagger+ \left(\frac{1}{\omega - E^0_5} + \frac{1}{\omega - E^0_4}\right)T_5 T_4^\dagger + \left(\frac{1}{\omega - E^0_5} + \frac{1}{\omega - E^0_5}\right)T_5 T_5^\dagger\\
		    &=\quad \frac{2}{\xi_1}|V_1|^2 \hat n_{d\beta}\hat n_{d\ol\beta} + \left(\frac{1}{\xi_1} + \frac{1}{\xi_4}\right)\sum_k V_1^* J_1^z c^\dagger_{d\beta}c_{k\beta}\hat n_{d\ol\beta}\\
		    &\quad+ \left(\frac{1}{\xi_1} + \frac{1}{\xi_5}\right)\sum_k V_1^* J^t \hat n_{d\beta}c_{k\ol\beta}c^\dagger_{d\ol\beta}\\
		    &\quad+ \left(\frac{1}{\omega - E^0_2} + \frac{1}{\omega - E^0_2}\right)T_2 T_2^\dagger\\
		    &\quad+ \left(\frac{1}{\omega - E^0_3} + \frac{1}{\omega - E^0_3}\right)T_3 T_3^\dagger\\
		    &\quad+ \left(\frac{1}{\omega - E^0_4} + \frac{1}{\omega - E^0_1}\right)T_4 T_1^\dagger+ \left(\frac{1}{\omega - E^0_4} + \frac{1}{\omega - E^0_4}\right)T_4 T_4^\dagger + \left(\frac{1}{\omega - E^0_4} + \frac{1}{\omega - E^0_5}\right)T_4 T_5^\dagger\\
		    &\quad+ \left(\frac{1}{\omega - E^0_5} + \frac{1}{\omega - E^0_1}\right)T_5 T_1^\dagger+ \left(\frac{1}{\omega - E^0_5} + \frac{1}{\omega - E^0_4}\right)T_5 T_4^\dagger + \left(\frac{1}{\omega - E^0_5} + \frac{1}{\omega - E^0_5}\right)T_5 T_5^\dagger\\
