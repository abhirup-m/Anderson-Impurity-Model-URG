...
\begin{equation}\begin{aligned}
	\Delta \epsilon_d &= \frac{2|V|^2}{\omega - \frac{D}{2} + \epsilon_d + \frac{J}{4}} - \frac{2|V|^2}{\omega - \frac{D}{2} - \epsilon_d + \frac{J}{2}} + \frac{3J^2}{8}\sum_k \frac{1}{\omega - \frac{D}{2} + \frac{J}{4}}\\
