...
\begin{figure}[htpb]
	...
	\caption{Variation of $\chi \times T$ over six decades of temperature. The low temperature behaviour is characteristic of a local Fermi liquid, while at high temperatures we see the Curie-Weiss paramagnetic susceptibility resulting from the local moment.}
\end{figure}
\begin{figure}[htpb]
	\centering
...
\end{aligned}\end{equation}
The states above the FS - \(k_2 \text{ and } k_3\) - do not appear because they are empty.
