...
\begin{equation}\begin{aligned}
	\epsilon_{k\sigma} = \epsilon_{k}^0 + \sum_{k^\prime}f_{kk^\prime}\hat n_{k^\prime\overline\sigma}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	C &= \frac{\:\mathrm{d}}{\:\mathrm{d}T}\sum_{k\sigma}\epsilon_{k\sigma}n_{k\sigma} \\
	    ...
	    &= \rho(0) T
\end{aligned}\end{equation}
where \(\rho = \rho_0 + \rho_{imp}\) is the total quasiparticle DOS with contributions from conduction bath and impurity.
\begin{equation}\begin{aligned}
	C_{imp} = \rho_{imp}T
\end{aligned}\end{equation}
...
\end{aligned}\end{equation}
Due to change in chemical potential, change in \(\epsilon_{k\sigma}\) should be isotropic and SU(2)-symmetric. Hence
\begin{equation}\begin{aligned}
...
\begin{equation}\begin{aligned}
	dm &= \sum_{k}\left(dn_{k \uparrow} - dn_{k \downarrow}\right) \\
	   ...
	   &\approx dB\rho(0) - \rho(0)f_0^aB\rho(0) \\
