...
\begin{equation}\begin{aligned}
	...
	= \left[\frac{J^2}{4\left( E_g + \frac{J}{4} \right)^2} - \frac{2V^2}{E_g^2}\right] \left[ H_0^* + \sum_{kk^\prime \sigma \sigma^\prime} f_{kk^\prime} \tau_{k\sigma} \tau_{k^\prime \sigma^\prime}\right]
\end{aligned}\end{equation}
