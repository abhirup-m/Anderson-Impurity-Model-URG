...
\end{aligned}\end{equation}
Substituting this into the total number of particles gives
\begin{equation}\begin{aligned}
...
\pb From the ground state wavefunction, we can calculate the average number of particles on the impurity:
\begin{equation}\begin{aligned}
...
\end{aligned}\end{equation}
The scattering phase shift suffered by the conduction electrons at the Fermi surface, off the impurity, is thus (from the FSR)
\begin{equation}\begin{aligned}
