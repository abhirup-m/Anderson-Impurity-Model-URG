...
\begin{equation}\begin{aligned}
	S_{FL} = \ln \left[{}^{N}C_{N_0}\right] = \ln \left[{}^{N}C_{N_<}\right] = \ln \frac{\left(N_0 + N_<\right)!}{N_<!}
\end{aligned}\end{equation}
Both the numbers \(N_0\) and \(N_<\) have topological stability. The entanglement entropy \(S_{FL}\) is thus a topological quantity.
\pb Using the previous approximations, this turns out to be
\begin{equation}\begin{aligned}
	S_{FL} = N_0\ln \left(\frac{N_<}{N_0}\right) \sim cL^{d-1}\ln L
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	S_{FL} - S_{MFL} = \ln \frac{{}^{N}C_{N^{FL}_<}}{{}^{N}C_{N^{MFL}_<}}
\end{aligned}\end{equation}
Assuming \(N^\text{FL} = N^\text{MFL}\), the fraction simplifies to
\begin{equation}\begin{aligned}
	\frac{{}^{N}C_{N^{FL}_<}}{{}^{N}C_{N^{MFL}_<}} = \frac{N^{MFL}_< ! \left( N_0^{MFL} + N_>^{MFL} \right)!}{N_<^{FL}!\; N_0^{FL}!}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\frac{{}^{N}C_{N^{FL}_<}}{{}^{N}C_{N^{MFL}_<}} = 1
\end{aligned}\end{equation}
and \(S_{FL} = S_{MFL}\), which essentially means that since the particle exchanges have happened completely inside the subsystem we are tracing out (Fermi surface and beyond), the connectivities between the two subsystems haven't changed and so the entanglement entropy is unchanged. 
\pb If, however, the extra states have come from inside the Fermi volume, then
\begin{equation}\begin{aligned}
	\frac{{}^{N}C_{N^{FL}_<}}{{}^{N}C_{N^{MFL}_<}} = \frac{N^{MFL}_< ! \left( N_0^{FL} + N_>^{MFL} \right)!}{N_<^{FL}!\; N_0^{FL}!} \approx \frac{N^{MFL}_< !}{N_<^{FL}!} && \left[N_0^{FL} \gg N_>^{MFL}\right] 
\end{aligned}\end{equation}
...
\end{aligned}\end{equation}
\comm{Continuing this procedure, if we trace out exactly \(N-1\) particles, we will get
\begin{equation}\begin{aligned}
...
\begin{equation}\begin{aligned}
	\ket{\Psi^{1}(\hat p_1 \hat p_2...\hat p_{N-1})}\bra{\Psi^{1}(\hat p_1 \hat p_2...\hat p_{N-1})} =  \ket{k}\bra{k}, \text{ such that }k \neq k_{p_i},  \forall \; i \in [1,N-1]
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	S^{N-m} = \text{Tr}\left[\rho^{N-m} \ln \rho^{N-m}\right] &= - \frac{1}{{d^m}} \ln \frac{1}{{d^m}} \sum_{s=1}^{d^m} = \ln {d^m} = \ln {}^N C_m
\end{aligned}\end{equation}
