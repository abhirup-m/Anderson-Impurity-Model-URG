...
\begin{equation}\begin{aligned}
	...
	\Delta U &= \frac{2|V_1|^2}{\xi_1^\prime} + \frac{2|V_0|^2}{\xi_2} - 2\frac{|V_1|^2}{\xi_1} - 2\frac{|V_0|^2}{\xi_2^\prime} - \sum_k \frac{1}{\xi_3}\left(2J_t^2 + J_z^2\right)\\
...
\subsection{Numerical analysis of symmetric Anderson-Kondo model}
We can look at a special case of the RG equations: \(\epsilon_q = D, \epsilon_d = -\frac{U}{2}, V_0 = V_1, J_z = J_t = \frac{J}{2}\).
\begin{equation}\begin{aligned}
	\Delta \epsilon_d &= \frac{|V|^2}{\omega - \frac{D}{2} + \epsilon_d + \frac{J}{4}} + \frac{|V|^2}{\omega - \frac{D}{2} + \epsilon_d + \frac{J}{2}} - \frac{2|V|^2}{\omega - \frac{D}{2} - \epsilon_d + \frac{J}{2}} + \frac{3J^2}{8}\sum_k \frac{1}{\omega - \frac{D}{2} + \frac{J}{4}}\\
...
\begin{equation}\begin{aligned}
	...
	&- \frac{1}{2}\left(\frac{1}{\xi_1} + \frac{1}{\xi_5} \right)V_1 K_t \left(1 - \hat n_{d\beta}\right)\left(c^\dagger_{k\ol\beta}c_{d\ol\beta} + \text{h.c.}\right)- \frac{1}{2}\left(\frac{1}{\xi_3} + \frac{1}{\xi_5} \right)K_z^1 K_t \left(c^\dagger_{d\beta}c^\dagger_{d\ol\beta}c_{k\beta}c_{k^\prime\ol\beta} + \text{h.c.}\right)
\end{aligned}\end{equation}
...
&- \frac{1}{2}\left(\frac{1}{\xi^\prime_2} + \frac{1}{\xi^\prime_5}\right)V_0 K_t\hat n_{d\beta}\left(c^\dagger_{k\ol\beta}c_{d\ol\beta} + \text{h.c.}\right) - \frac{1}{2}\left(\frac{1}{\xi^\prime_4} + \frac{1}{\xi^\prime_5}\right)K_z^0 K_t\left(c^\dagger_{d\beta}c^\dagger_{d\ol\beta}c_{k^\prime\beta}c_{k\ol\beta} + \text{h.c.}\right) 
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\omega^\prime_1 &= \omega + 2\epsilon_d + U\\
	\omega^\prime_2 &= \omega + \epsilon_d + \frac{K_z}{2}\\
...
\begin{equation}\begin{aligned}
	...
	\Delta U &= \frac{2|V_1|^2}{\xi_1^\prime} + \frac{2|V_0|^2}{\xi_2} -\frac{|V_1|^2}{\xi_1} - \frac{|V_0|^2}{\xi_2^\prime} + 2\sum_k\left(2\frac{K_z^2}{\xi_3} + \frac{K_t^2}{\xi_5}\right) \\
	...
	\Delta V_0 &= -\frac{1}{4}\left[V_1 K_t \left(\frac{1}{\xi_1} + \frac{1}{\xi_5}\right) + V_0 K_z \left(\frac{1}{\xi_2^\prime} + \frac{1}{\xi_4^\prime}\right)\right]\\
...
\begin{equation*}\begin{aligned}
	...
	\xi_2 &= \omega - \frac{\epsilon_q}{2} - \epsilon_d\\
	\xi_2^\prime &= \omega - \frac{\epsilon_q}{2} + \epsilon_d + K_z\\
	\xi_3 &= \xi_4 = \xi_3^\prime = \xi_4^\prime\\
	      &= \omega - \frac{\epsilon_q}{2} + \frac{K_z}{2}\\
	\xi_5 &= \omega - \frac{\epsilon_q}{2} - 2\epsilon_d - U + \frac{K_z}{2}\\
	\xi_5^\prime &= \omega - \frac{\epsilon_q}{2} + 2\epsilon_d + U + \frac{K_z}{2}\\
\end{aligned}\end{equation*}
\end{minipage}
...
\end{aligned}\end{equation}
\subsection{Numerical analysis of symmetric charge-Kondo model}
For the special case of eq.~\ref{symm-charge}, the RG equations simplify to
\begin{equation}\begin{aligned}
	\Delta \epsilon_d &= 2|V|^2\left(\frac{1}{\omega - \frac{D}{2} + \epsilon_d + \frac{K}{4}} - \frac{1}{\omega - \frac{D}{2} - \epsilon_d}\right) - \frac{3K^2}{8}\sum_k\frac{1}{\omega - \frac{D}{2} + \frac{K}{8}}\\
	\Delta V &= -\frac{3 K V}{8}\left(\frac{1}{\omega - \frac{D}{2} + \epsilon_d + \frac{K}{4}} + \frac{1}{\omega - \frac{D}{2} + \frac{K}{4}}\right)\\
	\Delta K &= -\frac{K^2}{4}\frac{1}{\omega - \frac{D}{2} + \frac{K}{8}}
\end{aligned}\end{equation}
