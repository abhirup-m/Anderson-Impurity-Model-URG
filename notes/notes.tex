...
\end{aligned}\end{equation}
The ground state is of course \(E^2_-\). The probabilities for the spin and charge sectors for the ground state look simpler:
\begin{equation}\begin{aligned}
...
\end{aligned}\end{equation}
Although \(E^2_-\) is the ground state of this two-dimensional subspace, we haven't yet shown that it is the ground state of the full Hilbert space. The eigenstates eq.~\ref{1} through \ref{2} are obviously higher than \(E_-\), because of the presence of the singlet \(- \frac{3}{4}j\) and the negative \(\gamma\) contribution compared to the positive triplet \( \frac{1}{4}j\) in those equations. The only other competitor is the low energy eigenstate in eq.~\ref{low}, which we call \(E_-^\prime\). The difference between \(E_-^2\) and \(E_-^1\) is
\begin{equation}\begin{aligned}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.45\textwidth]{../figures/gamma_N.pdf}
	\includegraphics[width=0.45\textwidth]{../figures/gamma_N2.pdf}
