...
\chapter{Preliminaries and Existing Results}\label{section1}
...
\begin{figure}[htpb]
	...
	\caption{Variation of $\chi$ against temperature. It saturates to a value close to \(\left( \pi T_K \right) ^{-1}\)}
\end{figure}
%\begin{figure}[htpb]
%	\centering
