...
The second and fourth quadrants - \( J<K, U>0 \) and \(J>K, U<0 \) respectively - are quite simple. They do not feauture any change in the fixed point nature of \(U\). \(U^*=0\)  remains the dominant nature, just as it was for \(V=0\). The fixed point value of \(V\) switches to \(V^*>V_0\) for an infinitesimal value, same as in the first quadrant. The competition between the fixed point values \(U^* = 0, U^*>U_0\) 
\begin{figure}[htpb!]
\centering
\includegraphics[scale=0.37]{../figures/frac_vs_D_quad2.pdf}
\includegraphics[scale=0.37]{../figures/frac_vs_D_quad22.pdf}
...
\begin{figure}[htpb!]
\centering
\includegraphics[scale=0.37]{../figures/frac_vs_D_quad4.pdf}
\includegraphics[scale=0.37]{../figures/frac_vs_D_quad44.pdf}
\caption{Variation of the fixed point values $J^*$ (left panel) and \(V^*\) (right panel), with the system size, for the fourth quadrant. All axes are in log scale.}
\end{figure}
\subsection{Third quadrant}
\begin{figure}[htpb!]
\centering
\includegraphics[scale=0.37]{../figures/frac_vs_D_quad3.pdf}
\includegraphics[scale=0.37]{../figures/frac_vs_D_quad33.pdf}
\caption{Variation of the fixed point values $J^*$ (left panel) and \(V^*\) (right panel), with the system size, for the fourth quadrant. All axes are in log scale.}
\end{figure}

\begin{figure}[htpb]
	\centering
	\includegraphics[scale=0.5]{../figures/phases_V.png}
	\caption{}
\end{figure}
