...
\begin{center}
	...
	\captionof{figure}{Variation of the fixed point value \(J^*\) against the bare bandwidth, in log scale. The straight line is a fit.}
	\label{JvsD-kondo}
\end{center}
...
This gives
\beq[cuturg]
\frac{\Delta \ham (\omega,D)}{\left[\ham^d_1\left(\omega_0 - \omega_1\right)\right]^{-1}} =  \qq{\qq{\ham^d,\ham^I},\ham}
\eeq
...
\end{itemize}
\begin{center}
	\includegraphics[scale=0.5]{../figures/Svsi.png}
...
\begin{center}
	\includegraphics[scale=0.35]{../figures/decay1.png}
