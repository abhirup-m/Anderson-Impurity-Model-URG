...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	\textcolor{black}{ % Red font color
		\textbf{\Huge Unitary Renormalization Group Solution}\\[10pt]
		\textbf{\Huge of The Single-Impurity Anderson Model}
	\vspace*{25pt}
	}
...
This is to certify that the thesis titled \textbf{Unitary Renormalization Group Solution of The Single-Impurity Anderson Model} which is submitted by \textbf{Abhirup Mukherjee} in partial fulfillment of the requirement for the award of the degree of MS in Integrated PhD in Physical Sciences to Indian Institute of Science Education and Research Kolkata is a record of the candidates own work carried out by him under my supervision. The matter embodied in this thesis is original and has not been submitted for the award of any other degree.
\pb
Signed:\\[5pt]
\rule[1em]{0.5\linewidth}{0.5pt}  % This prints a line for the signature
\pb
...
This means that the interacting excited states can be labeled by the same good quantum numbers \il{\vec k} and \il{\sigma}.That is, if some eigenstate of the interacting system flows into the ideal eigenstate \il{\{n_{k\sigma}\}}, we can just as well use the distribution \il{\{n_{k\sigma}\}} to label the interacting eigenstate.
...
In other words, a system (ideal ground state + particle of momentum \il{k}) goes to (interacting ground state + quasiparticle of momentum \il{k}).
...
\eeq
Using the Fierz identity \il{\delta_{\sigma_1\sigma_3}\delta_{\sigma_4\sigma_2} = \hf\delta_{\sigma_1\sigma_2}\delta_{\sigma_3\sigma_4} + \hf\vec\sigma_{\sigma_1\sigma_2}\cdot\vec\sigma_{\sigma_3\sigma_4}}, we can write
\beq
...
\beq
T^{(1)}_\text{non-flip} = T_{k_\ua,d_{\sigma} \ra q_\ua,d_{\sigma}} = \bra{q_\ua,d_{\sigma}}V\ket{k_\ua,d_{\sigma}} = m_d J
\eeq
