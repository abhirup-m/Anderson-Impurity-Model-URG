...
\begin{flalign*}
	...
	&-\frac{1}{2} \left(\frac{1}{\xi^\prime_4} + \frac{1}{\xi^\prime_1}\right)\frac{J_1^z}{2}\hat n_{d\ol\beta} \left(V_1 c^\dagger_{k\beta}c_{d\beta} + \text{h.c.}\right) - \frac{1}{2}\left(\frac{1}{\xi^\prime_1} + \frac{1}{\xi^\prime_5}\right)J_t \left\hat n_{d\beta}\left(V_1 c^\dagger_{k\ol\beta}c_{d\ol\beta} + \text{h.c.}\right) \\
...
\end{aligned}\end{equation}
We want to write all the \(\omega_i\) in terms of a single \(\omega = -\frac{\epsilon_q}{2} + \frac{1}{2}J_z\).
\begin{equation}\begin{aligned}
	\omega_1 &= \omega_3 = \omega_4 = \omega + \epsilon_d - \frac{J_z}{2}\\
	\omega_2 &= \omega - \frac{J_z}{2}\\
	\omega_5 &= \omega + \epsilon_d - J_z
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\omega^\prime_1 &= \omega + 2\epsilon_d + U - \frac{J_z}{2}\\
	\omega^\prime_2 &= \omega^\prime_3 = \omega + \epsilon_d\\
	\omega^\prime_4 &= \omega^\prime_5 = \omega + \epsilon_d - J_z\\
\end{aligned}\end{equation}
The denominators are therefore
\begin{equation}\begin{aligned}
	\xi_1^\prime &= \omega - \frac{\epsilon_q}{2} + \epsilon_d + U\\
	\xi_2^\prime &= \omega - \frac{\epsilon_q}{2} + \epsilon_d\\
...
\begin{equation*}\begin{aligned}
	...
	\xi_2 &= \omega - \frac{\epsilon_q}{2} - \epsilon_d\\[5pt]
\xi_3 &= \xi_4 = \xi_5 = \omega - \frac{\epsilon_q}{2} - \frac{J_z}{2}\\[5pt]
	\xi_1^\prime &= \omega - \frac{\epsilon_q}{2} + \epsilon_d + U\\[5pt]
\xi_2^\prime &= \omega - \frac{\epsilon_q}{2} + \epsilon_d\\[5pt]
...
\begin{equation}\begin{aligned}
	\Delta \epsilon_d &= \frac{|V|^2}{\omega - \frac{\epsilon_q}{2} + \epsilon_d - \frac{J}{4}} + \frac{|V|^2}{\omega - \frac{\epsilon_q}{2} + \epsilon_d} - \frac{2|V|^2}{\omega - \frac{\epsilon_q}{2} - \epsilon_d} + \frac{3J^2}{8}\sum_k \frac{1}{\omega - \frac{\epsilon_q}{2} - \frac{J}{4}}\\
	\Delta V &= -\frac{3J}{4}V\left(\frac{1}{\omega - \frac{\epsilon_q}{2} - \epsilon_d} + \frac{1}{\omega - \frac{\epsilon_q}{2} - \frac{J}{4}}\right)\\
