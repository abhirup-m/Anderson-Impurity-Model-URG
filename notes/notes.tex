...
If an interacting eigenstate corresponds to the state \(\{n_{k\sigma}\}\), then \(\{n_{k\sigma}\}\) is
said to be the quasiparticle distribution function for that interacting state.
...
\hfill
\begin{minipage}{0.4\textwidth}
    \centering\includegraphics[width=0.8\textwidth]{phsymm.png}
