...
\begin{equation}\begin{aligned}
	\ket{\uparrow} \equiv \ket{k_1 \uparrow, k_{-1} \uparrow} = \ket{\hat n_{k_1 \uparrow} = \hat n_{k_{-1} \uparrow} = 1, \hat n_{k_{-1} \downarrow} = \hat n_{k_1 \downarrow} = 0}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	S_2^z \ket{\uparrow} = \frac{1}{4}\left[\hat n_\uparrow - \hat n_\downarrow\right]\ket{k_1 \uparrow, k_{-1} \uparrow} = \frac{1}{2}\ket{\uparrow}
\end{aligned}\end{equation}
Similarly, the \(- \frac{1}{2}\) eigenstate is
\begin{equation}\begin{aligned}
	\ket{\downarrow} \equiv \ket{k_1 \downarrow, k_{-1} \downarrow}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\ket{\text{cloud}} = \frac{1}{2}\ket{\uparrow^d}\ket{k_1 \downarrow, k_{-1} \downarrow} - \frac{1}{2}\ket{\downarrow^d}\ket{k_1 \uparrow, k_{-1} \uparrow} + \frac{1}{2}\ket{2^d}\ket{0} - \frac{1}{2}\ket{0^d}\ket{k_1 \uparrow, k_1 \downarrow,k_{-1} \uparrow,k_{-1} \downarrow}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\ket{\text{IR}} \equiv \ket{\Psi_0} =& \ket{\hat n_{k_{-2}} = \hat n_{k_{-3}} = 2} \otimes \left[\frac{1}{2}\ket{\uparrow^d}\ket{k_1 \downarrow, k_{-1} \downarrow} - \frac{1}{2}\ket{\downarrow^d}\ket{k_1 \uparrow, k_{-1} \uparrow} + \frac{1}{2}\ket{2^d}\ket{0} \right.\\
					     &\left.- \frac{1}{2}\ket{0^d}\ket{k_1 \uparrow, k_1 \downarrow,k_{-1} \uparrow,k_{-1} \downarrow}\right] \otimes \ket{\hat n_{k_{2}} = \hat n_{k_{3}} = 0}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\big\vert\underbrace{n_{k_{3} \uparrow}n_{k_{3} \downarrow}n_{k_{2} \uparrow} n_{k_{2} \downarrow}}_\text{unoccupied IOMS}\quad \overbrace{n_{d \uparrow} n_{d \downarrow}}^\text{impurity} \quad \underbrace{n_{k_{1} \uparrow}n_{k_{1} \downarrow}n_{k_{-1} \uparrow}n_{k_{-1} \downarrow}}_\text{cloud} \quad \overbrace{n_{k_{-2} \uparrow}n_{k_{-2} \downarrow}n_{k_{-3} \uparrow}n_{k_{-3} \downarrow}}^\text{occupied IOMS}\big\rangle
\end{aligned}\end{equation}
