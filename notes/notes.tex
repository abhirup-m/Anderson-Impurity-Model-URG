...
\hline
\(>0\)& \(J > K\)& \(\gg 0\)&\(J^*>K^*\) & screened spin & \(\ket{\Psi}^*_1\)& \(- \frac{U^*}{2} - \frac{3}{4}J^* - \frac{1}{4}J^{**}\)\\
\(>0\)& \(J < K\)& \(0\) &\(J^*<K^*\) & screened charge & \(\ket{\Psi}^*_{0,2}\)& \(- \frac{3}{4}K^* - \frac{1}{4}K^{**}\)\\
\(<0\)& \(J > K\)& \(0\) &\(J^*>K^*\) & screened spin & \(\ket{\Psi}^*_1\)& \(- \frac{3}{4}J^* - \frac{1}{4}J^{**}\)\\
\(<0\)& \(J < K\)& \(\ll 0\)&\(J^*<K^*\) & screened charge & \(\ket{\Psi}^*_{0,2}\)& \(- \frac{3}{4}K^* - \frac{1}{4}K^{**}\)\\
\hline
\end{tabular}
...
\pb However, even for even a modest bare value of \(V\), the dominant behaviour flips in the first and third quadrants. Fixed points with \(U*=0\) form the majority of these phases, the \(U* \neq 0\) forming a much smaller subset. This difference becomes amplified as the bandwidth increases, and the only fixed point that survives at the thermodynamic limit is \(U^*=0\). 
