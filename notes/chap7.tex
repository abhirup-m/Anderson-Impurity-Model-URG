...
\label{results}
\section{Spin and charge susceptibilities}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.49\textwidth]{../spin-charge-symmetrical/chiT_J=0.020.pdf}
	\includegraphics[width=0.49\textwidth]{../spin-charge-symmetrical/chiT_J=0.100.pdf}
...
\begin{equation}\begin{aligned}
	\chi(\beta) = \beta \left(\left<\left(S_d^z\right)^2\right> - \left<S_d^z\right>^2\right) = \lim_{B \to 0}\frac{1}{\beta}\left[\frac{1}{Z(B)} \frac{\partial^2{Z(B)}}{\partial{B^2}}-\frac{1}{Z(B)^2} \left(\frac{\partial{Z(B)}}{\partial{B}}\right)^2\right]
\end{aligned}\end{equation}
where \(B\) is now a field that couples to the impurity isospin:
\begin{equation}\begin{aligned}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.49\textwidth]{../spin-charge-symmetrical/chi_chargeT_K=0.010.pdf}
	\includegraphics[width=0.49\textwidth]{../spin-charge-symmetrical/chi_chargeT_K=0.100.pdf}
	\label{chi_charge}
