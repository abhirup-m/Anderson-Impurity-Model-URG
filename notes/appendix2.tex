...
\begin{figure}[!htpb]
	\centering
	\includegraphics[width=0.65\textwidth]{../figures/phase-map-2_D=10.pdf}\\
	\includegraphics[width=0.65\textwidth]{../figures/phase-map-2_D=1000.pdf}
\end{figure}

\clearpage
\section{Evolution of ground state}
\subsection{Through overlaps against spin singlet and charge triplet zero states}
\begin{figure}[!htpb]
	\centering
	\includegraphics[width=0.49\textwidth]{../figures/overlaps_gs_D=10.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/overlaps_gs_D=100.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/overlaps_gs_D=300.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/overlaps_gs_D=500.pdf}
\end{figure}

\clearpage
\subsection{Through spin and charge correlations}
\begin{figure}[!htpb]
	\centering
	\includegraphics[width=0.49\textwidth]{../figures/corrs_gs_D=10.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/corrs_gs_D=100.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/corrs_gs_D=300.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/corrs_gs_D=500.pdf}
\end{figure}
