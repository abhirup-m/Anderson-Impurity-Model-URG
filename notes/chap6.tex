...
\begin{equation}\begin{aligned}
	H_\text{eff} = \ket{\Psi}_1\bra{\Psi}_1\otimes \left[\text{constant} + \alpha_\text{spin} \mathcal{P}_\text{spin} + \alpha_\text{charge} \mathcal{P}_\text{charge}\right] 
\end{aligned}\end{equation}
...
The behaviour of the net energy of the charge sector, \(\mathcal{F} \equiv \alpha_\text{charge} - \alpha_\text{spin}\) is shown in the red curves of figs.~\ref{charge_energy}. In each of the figures, the lower inset (blue) tracks the small parameter \(t^2/\delta E\) to make sure that the perturbation theory is valid. The upper insert (green) shows the variation of the gap between the ground state and the first excited state of the two-site model. We will now look at each of the cases separately.
\begin{itemize}
...
\begin{figure}
	\centering
	\includegraphics[height=0.24\textheight]{../figures/charge_energy_VJt_U.pdf}
	\includegraphics[height=0.24\textheight]{../figures/charge_energy_UVt_J.pdf}

	\includegraphics[height=0.24\textheight]{../figures/charge_energy_UJt_V.pdf}
	\includegraphics[height=0.24\textheight]{../figures/charge_energy_Jt_UV.pdf}

	\includegraphics[height=0.24\textheight]{../figures/charge_energy_Ut_VJ.pdf}
	\includegraphics[height=0.24\textheight]{../figures/charge_energy_Vt_UJ.pdf}

	\includegraphics[height=0.24\textheight]{../figures/charge_energy_t_UVJ.pdf}
	\caption{Variation of \(\mathcal{F}\) against the renormalised couplings and the hopping parameter \(t\).}
	\label{charge_energy}
\end{figure}
