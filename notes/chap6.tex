...
\begin{equation}\begin{aligned}
	\Delta U = 4V^2 n_j\left(\frac{1}{d_0} - \frac{1}{d_1}\right) - \frac{n_j}{2}\frac{J^2}{d_2} = 4V^2\left(U + \frac{J}{4}\right)\frac{n_j}{d_0 d_1} - \frac{n_j J^2}{2d_2}
\end{aligned}\end{equation}

For \(V>J\), we can expect \(U\) to be relevant. The internal consistency check is that a relevant \(U\) will make \(|d_2| > |d_1|\) and ensure \(V>J\). On the other hand, \(V<J\) will make \(U\) irrelevant.
