...
\subsection{Increasing correlations in the local Fermi liquid: transition from strong-coupling to local moment behaviour}
...
\begin{center}
	% \vspace*{10pt}
	\includegraphics[width=0.32\textwidth]{../figures/gap-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
	\includegraphics[width=0.32\textwidth]{../figures/par-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
	\includegraphics[width=0.32\textwidth]{../figures/lfl-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
\end{center}
The vanishing of the gap and the growth of the small parameter indicates the breakdown of perturbation theory around the singlet; this simply shows that there is a degeneracy in the local moment regime, and the efffective Hamiltonian will have to be obtained using degenerate perturbation theory. The presence of degeneracy also suggests that the effective Hamiltonian will be of the non-Fermi liquid type.

\subsubsection*{\large Behaviour of mutual information between various real space members}
\begin{center}
	\includegraphics[width=0.32\textwidth]{../figures/mi-01-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
	\includegraphics[width=0.32\textwidth]{../figures/mi-d0-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
	\includegraphics[width=0.32\textwidth]{../figures/mi-d1-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
\end{center}
The impurity-zeroth site mutual information \(I(d:0)\) remains unchanged at the maximum for an appreciable range of values, and this shows the stability of the singlet. Meanwhile, the mutual information between the zeroth site and the site nearest to it (\(I(0:1)\)) grows, because when the singlet weakens, the zeroth site is able to entangle more with the other sites. It finally saturates to its maximum value, which is the value produced as result of the tight-binding hopping. The mutual information between the impurity and sites beyond the zeroth site (\(I(d:1)\)) show a non-monotonic behaviour; it first increases as the entanglement that was initially restricted to just the impurity and the zeroth sites begins "seeping" into the other sites as well. Beyond a critical value of \(U/J\), \(I(d:1)\) starts dropping, because the entanglement has now mostly shifted out of the impurity+zeroth site system and into conduction bath.

\begin{center}
	\includegraphics[width=0.4\textwidth]{../figures/I-all-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
\end{center}
When plotted in the same frame, the mutual information measures for for various sites \(I(d:i)\) reveal the periodic boundary conditions imposed on the underlying lattice; sites 1 and 5 are symmetrically placed with respect to the zeroth site, so \(I(d:1)\) and \(I(d:5)\) overlap perfectly. Similarly, \(I(d:2)\) overlaps perfectly with \(I(d:4)\).

\subsubsection*{\large Behaviour of impurity entanglement entropy}
\begin{center}
	\includegraphics[width=0.32\textwidth]{../figures/EE-d-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
\end{center}
The von-Neumann entanglement entropy \(S(d)\) of the impurity shows pretty straigtforward behaviour. It is maximum for \(U \ll J\) because it is in a singlet configuration. For \(U \gg J\), the singlet weakens and the impurity begins to decouple from the bath, leading to a reduction in \(S(d)\).

\subsubsection*{\large Behaviour of spin-spin correlations}
\begin{center}
	\includegraphics[width=0.32\textwidth]{../figures/corr-d0-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
	\includegraphics[width=0.32\textwidth]{../figures/corr-d1-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
	\includegraphics[width=0.32\textwidth]{../figures/corr-d2-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
	\includegraphics[width=0.5\textwidth]{../figures/corr-all-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
\end{center}

\subsubsection*{\large Spin-spin correlations as function of distance}
\begin{center}
	\includegraphics[width=0.32\textwidth]{../figures/corr-di-min-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
	\includegraphics[width=0.32\textwidth]{../figures/corr-di-max-t=0.100,J=1_over_U,V=J,N=6,U=0.010,316.228,200.pdf}
\end{center}
...
% 	% \includegraphics[width=0.4\textwidth]{../figures/gap-charge_energy_VJt_U.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/mi-charge_energy_VJt_U.pdf}


% 	% \includegraphics[width=0.32\textwidth]{../figures/l-charge_energy_UVt_J.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/gap-charge_energy_UVt_J.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/mi-charge_energy_UVt_J.pdf}


% 	% \includegraphics[width=0.32\textwidth]{../figures/l-charge_energy_UJt_V.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/gap-charge_energy_UJt_V.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/mi-charge_energy_UJt_V.pdf}


% 	% \includegraphics[width=0.32\textwidth]{../figures/l-charge_energy_Jt_UV.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/gap-charge_energy_Jt_UV.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/mi-charge_energy_Jt_UV.pdf}


% 	% \includegraphics[width=0.32\textwidth]{../figures/l-charge_energy_Ut_VJ.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/gap-charge_energy_Ut_VJ.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/mi-charge_energy_Ut_VJ.pdf}


% 	% \includegraphics[width=0.32\textwidth]{../figures/l-charge_energy_Vt_UJ.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/gap-charge_energy_Vt_UJ.pdf}
% 	% \includegraphics[width=0.4\textwidth]{../figures/mi-charge_energy_Vt_UJ.pdf}


% 	\includegraphics[width=0.4\textwidth]{../figures/lfl-charge_energy_t_UVJ.pdf}
% 	\includegraphics[width=0.4\textwidth]{../figures/gap-charge_energy_t_UVJ.pdf}
% 	\includegraphics[width=0.4\textwidth]{../figures/par-charge_energy_t_UVJ.pdf}
% 	\includegraphics[width=0.4\textwidth]{../figures/mi-01-charge_energy_t_UVJ.pdf}
% 	\includegraphics[width=0.4\textwidth]{../figures/mi-d1-charge_energy_t_UVJ.pdf}
% 	\includegraphics[width=0.4\textwidth]{../figures/mi-d0-charge_energy_t_UVJ.pdf}
% 	\includegraphics[width=0.4\textwidth]{../figures/EE-d-charge_energy_t_UVJ.pdf}
% 	\includegraphics[width=0.4\textwidth]{../figures/corr-d0-charge_energy_t_UVJ.pdf}
% 	\includegraphics[width=0.4\textwidth]{../figures/corr-d1-charge_energy_t_UVJ.pdf}
% 	\includegraphics[width=0.4\textwidth]{../figures/corr-k-charge_energy_t_UVJ.pdf}
