...
where \(V\gamma = \frac{3J}{8} + \frac{U}{4}\) and \(\Delta = \sqrt{\frac{U^2}{4} + 4V^2}\).
...
\end{aligned}\end{equation}
\(\mathcal{P}_\text{spin}\) and \(\mathcal{P}_\text{charge}\) project, respectively,  onto the spin and charge sectors of the first site. The fact that the charge sector comes with a positive factor means that the holon-doublon states are repulsive, and this renormalisation of the states generates an effective particle-hole symmetric Fermi liquid interaction on the first site - also known as the local Fermi liquid~\cite{nozieres1974fermi}.

\begin{figure}[!htpb]
	\centering
	\includegraphics[width=0.49\textwidth]{../figures/charge_energy_VJt_U.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/charge_energy_UVt_J.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/charge_energy_UJt_V.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/charge_energy_Ut_VJ.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/charge_energy_Vt_UJ.pdf}
	\includegraphics[width=0.49\textwidth]{../figures/charge_energy_Jt_UV.pdf}
\end{figure}
